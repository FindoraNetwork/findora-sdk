    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                ...
                inputNumbers = 5;
                assetBlindRules = { isAmountBlind: false };
                return [4 /*yield*/, api_1.Asset.issueAsset(walletInfo, tokenCode, "".concat(inputNumbers), assetBlindRules)];
            case 7:
                issueAssetBuilder = _a.sent();
                return [4 /*yield*/, api_1.Transaction.submitTransaction(issueAssetBuilder)];
            case 8:
            ...
            case 9:
                ...
                return [4 /*yield*/, api_1.Transaction.sendToAddress(walletInfo, toWalletInfo.address, "".concat(inputNumbers / 2), tokenCode, assetBlindRulesForSend)];
            case 10:
