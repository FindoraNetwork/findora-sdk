...
var ERROR_MESSAGES =
  ...
  (_a[COMMANDS.RESTORE_WALLET] =
    'please run as "yarn cli restoreWallet --mnemonicString=\'XXX ... ... XXX\'"'),
  (_a[COMMANDS.BATCH_SEND_ERC20] = 'please run as "yarn cli batchSendErc20 --filePath="./file.csv"'),
  (_a[COMMANDS.BATCH_SEND_FRA] =
    'please run as "yarn cli batchSendFra --privateKey=XXX --filePath="./fileFra.csv"'),
  (_a[COMMANDS.CREATE_AND_SAVE_WALLETS] =
    'please run as "yarn cli createAndSaveWallets --numberOfWallets=10'),
  _a);
  ...
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      ...
      (address = argv.address),
        (amountToFund = argv.amountToFund),
        (mnemonicString = argv.mnemonicString),
        (filePath = argv.filePath),
        (privateKey = argv.privateKey),
        (numberOfWallets = argv.numberOfWallets);
      if (!command) {
        showHelp();
        return [2 /*return*/];
      }
