...
exports.runBatchDeployTicket = void 0;
...
var defaultFileName = 'fileDeployTicket.csv';
var resultFileLogName = "batchDeployTicketLog";
var isCsvValid = function (listOfRecords) {
    for (var i = 0; i < listOfRecords.length; i += 1) {
        ...
        var isTotalPresented = Object.keys(currentRecord).includes('totalSupply');
        var isLimitPresented = Object.keys(currentRecord).includes('limitPerMint');
        ...
        if (!isTickPresented || !isTotalPresented || !isLimitPresented || !isMinPresented || !isMaxPresented) {
            throw Error("ERROR - The data row must have \"tick\", \"totalSupply\", \"limitPerMint\", \"rndSecMin\" and \"rndSecMax\" fields ".concat(JSON.stringify(currentRecord), " "));
        }
    }
    return true;
};
...
var runBatchDeployTicket = function (filePath, fromPk) { return __awaiter(void 0, void 0, void 0, function () {
    var data, parsedListOfRecords, err_1, error_2, password, walletFrom, processedInfo, errorsInfo, recordsList, i, _i, recordsList_1, currentRecord, tick, totalSupply, limitPerMint, rndSecMin, rndSecMax, waitTimeInMSec, txHash, rowData, errorMessage, error_3, rowData, errorMessage;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
            ...
            case 9:
                ...
                tick = currentRecord.tick, totalSupply = currentRecord.totalSupply, limitPerMint = currentRecord.limitPerMint, rndSecMin = currentRecord.rndSecMin, rndSecMax = currentRecord.rndSecMax;
                waitTimeInMSec = (0, utils_1.getRandomNumber)(rndSecMin * 1000, rndSecMax * 1000);
                return [4 /*yield*/, (0, brc20_1.sendBRC20DeployTx)(tick, totalSupply, limitPerMint, walletFrom)];
            case 10:
                txHash = _a.sent();
...
exports.runBatchDeployTicket = runBatchDeployTicket;
//# sourceMappingURL=batchDeployTicket.js.map