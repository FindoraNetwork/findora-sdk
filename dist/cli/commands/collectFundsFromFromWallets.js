...
exports.runCollectFundsFromeWallets = void 0;
...
var runCollectFundsFromeWallets = function (filePath, privateKeyOfReceiver) { return __awaiter(void 0, void 0, void 0, function () {
    var data, err_1, receiverWalletInfo, walletsList, resultList, _i, walletsList_1, currentWallet, _a, privateKey, address, index, balanceResult, err_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                ...
                console.log('reciverWalletInfo', receiverWalletInfo);
                walletsList = [];
                try {
                ...
                _b.label = 5;
            case 5:
                if (!(_i < walletsList_1.length)) return [3 /*break*/, 10];
...
exports.runCollectFundsFromeWallets = runCollectFundsFromeWallets;
//# sourceMappingURL=collectFundsFromFromWallets.js.map