...
var runBatchSendERC20 = function (filePath) { return __awaiter(void 0, void 0, void 0, function () {
    var data, parsedListOfRecievers, err_1, error_1, provider, web3, sendInfo, errorsInfo, senderAccount, i, currentReciever, isAddressPresented, isAmountPresented, tokenAllocated, tokenReceiveAddress, recieverInfo, _a, txHash, txReceipt, error_2, errorMessage;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 8:
                ...
                _b.label = 9;
            case 9:
                if (!(i < parsedListOfRecievers.length)) return [3 /*break*/, 14];
                currentReciever = parsedListOfRecievers[i];
                isAddressPresented = Object.keys(currentReciever).includes('tokenReceiveAddress');
                isAmountPresented = Object.keys(currentReciever).includes('tokenAllocated');
                ...
                tokenAllocated = currentReciever.tokenAllocated, tokenReceiveAddress = currentReciever.tokenReceiveAddress;
                recieverInfo = {
            ...
            case 12:
                error_2 = _b.sent();
                errorMessage = i + 1 + ": !! ERROR!! - could not send a transaction to " + tokenReceiveAddress + ". Error: - " + error_2.message + ". Skipping....";
