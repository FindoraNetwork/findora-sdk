...
exports.getProcessor = exports.processDefineAsset = void 0;
var Keypair = __importStar(require("../../keypair"));
var asset_1 = require("../../../config/asset");
var get_1 = __importDefault(require("lodash/get"));
var processUnsupported = function (_) { return __awaiter(void 0, void 0, void 0, function () {
    var data;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Keypair.getAddressByPublicKey(asset.issuer.key)];
            case 1:
                from = _a.sent();
                data = {
                    // ...item,
...
var processors = {
    DefineAsset: exports.processDefineAsset,
