...
export declare const getOwnedSids: (
  address: string,
  config?: Types.NetworkAxiosConfig,
) => Promise<Types.OwnedSidsDataResult>;
export declare const getRelatedSids: (
  address: string,
  config?: Types.NetworkAxiosConfig,
) => Promise<Types.OwnedSidsDataResult>;
export declare const getUtxo: (
  utxoSid: number,
  config?: Types.NetworkAxiosConfig,
) => Promise<Types.UtxoDataResult>;
export declare const getOwnerMemo: (
  utxoSid: number,
  config?: Types.NetworkAxiosConfig,
) => Promise<Types.OwnerMemoDataResult>;
export declare const getAbarOwnerMemo: (
  atxoSid: string,
  config?: Types.NetworkAxiosConfig,
) => Promise<Types.OwnerMemoDataResult>;
export declare const getMTLeafInfo: (
  atxoSid: string,
  config?: Types.NetworkAxiosConfig,
 ...
 */
export declare const getStateCommitment: (
  config?: Types.NetworkAxiosConfig,
...
export declare const submitTransaction: <T extends string>(
  data?: T | undefined,
  config?: Types.NetworkAxiosConfig,
) => Promise<Types.SubmitTransactionDataResult>;
export declare const getAssetToken: (
  assetCode: string,
  config?: Types.NetworkAxiosConfig,
) => Promise<Types.AssetTokenDataResult>;
export declare const getIssuedRecords: (
  address: string,
  config?: Types.NetworkAxiosConfig,
 ...
 */
export declare const getTransactionStatus: (
  handle: string,
  config?: Types.NetworkAxiosConfig,
...
export declare const getHashSwap: (
  hash: string,
  config?: Types.NetworkAxiosConfig,
) => Promise<Types.HashSwapDataResult>;
export declare const getParamsForTransparentTxList: (
  address: string,
  type: 'to' | 'from',
  page?: number,
) => Types.TxListQueryParams;
export declare const getAnonymousTxList: (
  subject: string,
  type: 'to' | 'from',
  page?: number,
) => Types.TxListQueryParams;
export declare const getTxList: (
  subject: string,
  type: 'to' | 'from',
  page?: number,
  privacy?: 'transparent' | 'anonymous',
  config?: Types.NetworkAxiosConfig,
...
export declare const getAbciNoce: (
  data: string,
  config?: Types.NetworkAxiosConfig,
) => Promise<Types.AbciNoceResult>;
export declare const getAbciInfo: (
  data: string,
  config?: Types.NetworkAxiosConfig,
) => Promise<Types.AbciInfoResult>;
export declare const submitEvmTx: (
  tx: string,
  config?: Types.NetworkAxiosConfig,
) => Promise<Types.SubmitEvmTxResult>;
export declare const getValidatorList: (
  config?: Types.NetworkAxiosConfig,
) => Promise<Types.ValidatorListDataResult>;
export declare const getDelegateInfo: (
  publickey: string,
  config?: Types.NetworkAxiosConfig,
) => Promise<Types.DelegateInfoDataResult>;
export declare const sendRpcCall: <T>(
  url: string,
  givenPayload: {
    [key: string]: any;
  },
...
export declare const sendRpcCallV2: <N>(
  givenPayload: N,
  config?: Types.NetworkAxiosConfig,
) => Promise<Types.NetworkAxiosDataResult>;
export declare const getRpcPayload: <T>(
  msgId: number,
  method: string,
...
export declare const getOwnedAbars: (
  commitment: string,
  config?: Types.NetworkAxiosConfig,
) => Promise<Types.OwnedAbarsDataResult>;
export declare const checkNullifierHashSpent: (
  hash: string,
  config?: Types.NetworkAxiosConfig,
