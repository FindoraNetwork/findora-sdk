...
exports.sendEvmToAccount =
  exports.sendAccountToEvm =
  exports.frc20ToBar =
  exports.fraToBar =
  exports.fraAddressToHashAddress =
    void 0;
...
var toHex = function (covertThis, padding) {
  var temp1 = ethers_1.ethers.utils.hexZeroPad(
    ethers_1.ethers.utils.hexlify(BigInt(covertThis).toString()),
    padding,
  );
  return temp1;
};
exports.fraAddressToHashAddress = fraAddressToHashAddress;
var fraToBar = function (bridgeAddress, recipientAddress, amount, webLinkedInfo) {
...
var frc20ToBar = function (bridgeAddress, recipientAddress, tokenAddress, tokenAmount, webLinkedInfo) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          return [
            2 /*return*/,
            contract.methods.depositFRC20(tokenAddress, findoraTo, bridgeAmount).send(sendObj),
          ];
      }
    });
  });
...
var sendAccountToEvm = function (walletInfo, amount, ethAddress, assetCode, lowLevelData) {
  return __awaiter(void 0, void 0, void 0, function () {
    var ledger,
      address,
      fraAssetCode,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            Transaction.sendToAddress(walletInfo, address, amount, mainAssetCode, assetBlindRules),
          ];
        case 2:
 ...
 */
var sendEvmToAccount = function (fraAddress, amount, ethPrivate, ethAddress) {
  return __awaiter(void 0, void 0, void 0, function () {
    var ledger,
      accountPublickey,
      asset,
