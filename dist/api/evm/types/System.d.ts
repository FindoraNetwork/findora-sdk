...
export type ContractContext = Web3ContractContext<System, SystemMethodNames, SystemEventsContext, SystemEvents>;
...
export type SystemMethodNames = 'claim' | 'config' | 'delegate' | 'getClaimOnContractAddress' | 'getTriggerOnContractAddress' | 'getValidator' | 'getValidatorsList' | 'importDelegators' | 'importReward' | 'importUndelegations' | 'importValidators' | 'initialize' | 'owner' | 'renounceOwnership' | 'replaceDelegator' | 'setConfig' | 'stake' | 'systemClaim' | 'systemDelegate' | 'systemReplaceDelegator' | 'systemStake' | 'systemUndelegate' | 'systemUpdateValidator' | 'transferOwnership' | 'trigger' | 'undelegate' | 'updateValidator';
...
export interface System {
     ...
     */
    stake(validator: string, publicKey: string | number[], memo: string, rate: string): MethodPayableReturnContext;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     * @param delegatorPk Type: bytes, Indexed: false
     */
    systemReplaceDelegator(validators: string[], oldDelegator: string, newDelegator: string, delegatorPk: string | number[]): MethodReturnContext;
    /**
     * Payable: true
     * Constant: false
     * StateMutability: payable
     ...
     */
    trigger(proposer: string, voted: string[], unvoted: string[], byztine: string[], behavior: string | number[], preIssueAmount: string): MethodReturnContext;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
