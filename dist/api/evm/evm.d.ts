...
export declare const approveNFT: (tokenAddress: string, deckAddress: string, price: string, tokenId: string, nftType: string, web3WalletInfo: IWebLinkedInfo) => Promise<import("web3-eth").TransactionReceipt>;
