...
describe('triple masking (unit test)', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(TripleMasking.barToAbar(walletInfo, sid, anonKeys)).rejects.toThrow("could not fetch utxo for sid ".concat(sid))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(TripleMasking.barToAbar(walletInfo, sid, anonKeys)).rejects.toThrow("Could not fetch memo data for sid \"".concat(sid, "\", Error - ").concat(ownerMemoDataResult.error.message))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(TripleMasking.barToAbar(walletInfo, sid, anonKeys)).rejects.toThrow("Could not get decode memo data or get assetRecord\", Error - ".concat(fromJsonError.message))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(TripleMasking.barToAbar(walletInfo, sid, anonKeys)).rejects.toThrow("Could not convert AXfrPublicKey\", Error - ".concat(getAXfrPublicKeyByBase64Error.message))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(TripleMasking.barToAbar(walletInfo, sid, anonKeys)).rejects.toThrow("Could not convert AXfrPublicKey\", Error - ".concat(getXPublicKeyByBase64Error.message))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(TripleMasking.barToAbar(walletInfo, sid, anonKeys)).rejects.toThrow("Could not add bar to abar operation\", Error - ".concat(addOperationBarToAbarError.message))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(TripleMasking.barToAbar(walletInfo, sid, anonKeys)).rejects.toThrow("could not get a list of commitments strings \"".concat(getCommitmentsError.message, "\""))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(TripleMasking.barToAbar(walletInfo, sid, anonKeys)).rejects.toThrow('list of commitments strings is empty ')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(TripleMasking.barToAbar(walletInfo, sid, anonKeys)).rejects.toThrow("Could not save cache for bar to abar. Details: ".concat(saveBarToAbarToCacheError.message))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    describe('saveBarToAbarToCache', function () {
        ...
        it('return a instance of BarToAbarData and print `for browser mode a default fullPathToCacheEntry was used`', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, TripleMasking.saveBarToAbarToCache(walletInfo, sid, commitments, anonKeys)];
                    case 1:
                        result = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, TripleMasking.saveBarToAbarToCache(walletInfo, sid, commitments, anonKeys)];
                    case 1:
                        result = _a.sent();
                        expect(result).toMatchObject({
                            anonKeysFormatted: anonKeys,
