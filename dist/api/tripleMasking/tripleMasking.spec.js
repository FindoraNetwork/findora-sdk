            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(TripleMasking.barToAbar(walletInfo, sid, anonKeys)).rejects.toThrow("could not get a list of commitments strings \"" + getCommitmentsError.message + "\"")];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
