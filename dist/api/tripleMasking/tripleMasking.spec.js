...
describe('triple masking (unit test)', function () {
  describe('barToAbar', function () {
    ...
    it('throw an error if could not convert AXfrPublicKey. [Keypair.getXPublicKeyByBase64]', function () {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              spyGetXPublicKeyByBase64.mockImplementationOnce(function () {
                return Promise.reject(getXPublicKeyByBase64Error);
              });
              return [
                4 /*yield*/,
                expect(TripleMasking.barToAbar(walletInfo, [sid], anonKeys.axfrPublicKey)).rejects.toThrow(
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              spyGetXPublicKeyByBase64.mockImplementationOnce(function () {
                return Promise.resolve(returnEncKey);
              });
    ...
    it('throw an error if could not save cache for bar to abar. [TripleMasking.saveBarToAbarToCache]', function () {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              spySaveBarToAbarToCache.mockImplementationOnce(function () {
                return Promise.reject(saveBarToAbarToCacheError);
              });
              return [
                4 /*yield*/,
                expect(TripleMasking.barToAbar(walletInfo, [sid], anonKeys.axfrPublicKey)).rejects.toThrow(
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              spySaveBarToAbarToCache.mockImplementationOnce(function () {
                return Promise.resolve(barToAbarData);
              });
    ...
    it('throw an error if receive error response from get ownedAbars call', function () {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          spyGetAXfrPublicKeyByBase64.mockImplementationOnce(function () {
            return Promise.resolve(axfrPublicKey);
          });
          spyRandomizeAxfrPubkey.mockImplementationOnce(function () {
            return randomizeAxfrPubkey;
          });
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              expect(spyConsoleLog).toHaveBeenCalledWith(
                'Could not write cache for abarDataCache, "'.concat(cacheWriteError.message, '"'),
              );
              return [2 /*return*/];
          }
        });
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              expect(spyConsoleLog).toHaveBeenCalledWith(
                'Could not write cache for ownedAbarsCache, "'.concat(cacheWriteError.message, '"'),
              );
              return [2 /*return*/];
          }
        });
