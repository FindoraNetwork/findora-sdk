...
export declare const abarToAbar: (atxoSid: number, ownedAbar: FindoraWallet.OwnedAbar, anonKeys: FindoraWallet.FormattedAnonKeys, anonKeysReceiver: FindoraWallet.FormattedAnonKeys) => Promise<void>;
