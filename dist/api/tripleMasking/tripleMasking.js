...
var barToAbar = function (walletInfo, sid, anonKeys) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 10:
                error_8 = _b.sent();
                throw new Error("Could not convert AXfrPublicKey\", Error - ".concat(error_8.message));
            case 11:
            ...
            case 14:
                error_9 = _b.sent();
                throw new Error("Could not get fee inputs for bar to abar operation\", Error - ".concat(error_9.message));
            case 15:
...
var getNullifierHashesFromCommitments = function (anonKeys, givenCommitmentsList) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                error_10 = _a.sent();
                console.log("getOwnedAbars for '".concat(axfrPublicKey, "'->'").concat(givenCommitment, "' returned an error. ").concat(error_10.message), console.log('Full Error', error_10));
                return [3 /*break*/, 7];
            case 5:
