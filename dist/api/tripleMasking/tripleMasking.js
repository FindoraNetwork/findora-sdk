...
exports.getSendAtxo =
  exports.genNullifierHash =
  exports.getOwnedAbars =
  exports.getAbarBalance =
  exports.getAllAbarBalances =
  exports.getSpentBalance =
  exports.getBalance =
  exports.getBalanceMaps =
  exports.openAbar =
  exports.getSpentAbars =
  exports.getUnspentAbars =
  exports.getNullifierHashesFromCommitments =
  exports.isNullifierHashSpent =
  exports.abarToBar =
  exports.barToAbar =
  exports.getAbarTransferFee =
  exports.prepareAnonTransferOperationBuilder =
  exports.abarToAbar =
  exports.saveOwnedAbarsToCache =
  exports.saveBarToAbarToCache =
  exports.genAnonKeys =
    void 0;
      ...
      switch (_a.label) {
        ...
        case 3:
          ...
          try {
            ...
            throw new Error(
              'could not get release the anonymous keys instance  "'.concat(error.message, '" '),
            );
          }
...
var resolvePathToCacheEntry = function (cacheEntryName) {
  var fullPathToCacheEntry = ''
    .concat(Sdk_1.default.environment.cachePath, '/')
    .concat(cacheEntryName, '.json');
  try {
...
var saveBarToAbarToCache = function (walletInfo, sid, commitments, receiverAxfrPublicKey) {
  return __awaiter(void 0, void 0, void 0, function () {
    var cacheDataToSave,
      cacheEntryName,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            factory_1.default.read(fullPathToCacheEntry, Sdk_1.default.environment.cacheProvider),
          ];
        case 2:
        ...
        case 3:
          error_1 = _a.sent();
          console.log(
            'Error reading the abarDataCache for '.concat(
              walletInfo.address,
              '. Creating an empty object now',
            ),
          );
          return [3 /*break*/, 4];
        case 4:
        ...
        case 5:
          ...
          return [
            4 /*yield*/,
            factory_1.default.write(
              fullPathToCacheEntry,
              __assign(__assign({}, abarDataCache), cacheDataToSave),
              Sdk_1.default.environment.cacheProvider,
            ),
          ];
        case 6:
          _a.sent();
        ...
        case 7:
          ...
          return [3 /*break*/, 8];
        case 8:
          return [2 /*return*/, barToAbarData];
      }
    });
  });
};
exports.saveBarToAbarToCache = saveBarToAbarToCache;
var saveOwnedAbarsToCache = function (walletInfo, ownedAbars, savePath) {
  return __awaiter(void 0, void 0, void 0, function () {
    var cacheDataToSave,
      cacheEntryName,
      fullPathToCacheEntry,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          error_3 = _a.sent();
          console.log(
            'Error reading the ownedAbarsCache for '.concat(
              walletInfo.address,
              '. Creating an empty object now',
            ),
          );
...
var getAbarFromJson = function (ownedAbar) {
  return __awaiter(void 0, void 0, void 0, function () {
...
var getAbarOwnerMemo = function (atxoSid) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          if (memoError) {
            throw new Error(
              'Could not fetch abar memo data for sid "'
                .concat(atxoSid, '", Error - ')
                .concat(memoError.message),
            );
          }
          try {
...
var getMyMTLeafInfo = function (atxoSid) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          if (mTLeafInfoError) {
            throw new Error(
              'Could not fetch mTLeafInfo data for sid "'
                .concat(atxoSid, '", Error - ')
                .concat(mTLeafInfoError.message),
            );
          }
          if (!mTLeafInfo) {
            throw new Error(
              'Could not fetch mTLeafInfo data for sid "'.concat(atxoSid, '", Error - mTLeafInfo is empty'),
            );
          }
          try {
...
var getAnonKeypairFromJson = function (anonKeys) {
  return __awaiter(void 0, void 0, void 0, function () {
    var aXfrSpendKeyConverted,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          (axfrSpendKey = anonKeys.axfrSpendKey),
            (axfrPublicKey = anonKeys.axfrPublicKey),
            (axfrViewKey = anonKeys.axfrViewKey);
          _a.label = 1;
        case 1:
          _a.trys.push([1, 5, , 6]);
...
var getAnonPubKeyFromString = function (anonPubKey) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          return [2 /*return*/, axfrPublicKeyConverted];
      }
    });
  });
};
var getAbarTransferInputPayload = function (ownedAbarItem, anonKeysSender) {
  return __awaiter(void 0, void 0, void 0, function () {
    var abarData,
      atxoSid,
      ownedAbar,
...
var abarToAbar = function (
  ...
  if (additionalOwnedAbarItems === void 0) {
    additionalOwnedAbarItems = [];
  }
  return __awaiter(void 0, void 0, void 0, function () {
    var calculatedFee,
      balanceAfterSendToBN,
      isMoreFeeNeeded,
      msg,
      anonTransferOperationBuilder,
      commitmentsMap,
      processedCommitmentsMap,
      abarToAbarData;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
        ...
        case 1:
          ...
          if (isMoreFeeNeeded) {
            msg = 'Could not process abar transfer. More fee are needed. Required amount at least "'.concat(
              calculatedFee,
              ' FRA"',
            );
            throw new Error(msg);
          ...
          return [
            4 /*yield*/,
            (0, exports.prepareAnonTransferOperationBuilder)(
              anonKeysSender,
              anonPubKeyReceiver,
              abarAmountToTransfer,
              ownedAbarToUseAsSource,
        ...
        case 2:
          ...
          try {
            commitmentsMap =
              anonTransferOperationBuilder === null || anonTransferOperationBuilder === void 0
                ? void 0
                : anonTransferOperationBuilder.get_commitment_map();
          } catch (err) {
        ...
        case 3:
          ...
          return [
            2 /*return*/,
            { anonTransferOperationBuilder: anonTransferOperationBuilder, abarToAbarData: abarToAbarData },
          ];
      }
    });
  });
...
var prepareAnonTransferOperationBuilder = function (
  ...
  return __awaiter(void 0, void 0, void 0, function () {
    var anonTransferOperationBuilder,
      aXfrSpendKeySender,
      axfrPublicKeyReceiver,
      abarPayloadOne,
      _i,
      additionalOwnedAbarItems_1,
      ownedAbarItemOne,
      abarPayloadNext,
      toAmount,
      ledger,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, Builder.getAnonTransferOperationBuilder()];
        case 1:
          anonTransferOperationBuilder = _a.sent();
        ...
        case 4:
          ...
          try {
            ...
            throw new Error(
              'Could not add an input for abar transfer operation", Error - '.concat(error.message),
            );
          }
        ...
        case 6:
          ...
          try {
            ...
            throw new Error(
              'Could not add an additional input for abar transfer operation", Error - '.concat(
                error.message,
              ),
            );
          }
        ...
        case 10:
          ledger = _a.sent();
          amountAssetType = ledger.open_abar(
            abarPayloadOne.myOwnedAbar,
            abarPayloadOne.abarOwnerMemo,
            aXfrSpendKeySender,
          );
        ...
        case 11:
          error_7 = _a.sent();
          throw new Error(
            'Could not add an output for abar transfer operation", Error - '.concat(error_7.message),
          );
        case 12:
...
var processAbarToAbarCommitmentResponse = function (commitmentsMap) {
  return __awaiter(void 0, void 0, void 0, function () {
    var commitmentKeys,
      responseMap,
      _i,
      ...
      commitmentNumericAssetType,
      commitmentAmountInWei,
      commitmentAssetType,
      commitmentAmount;
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          (commitmentAxfrPublicKey = commitmentEntity[0]),
            (commitmentNumericAssetType = commitmentEntity[1]),
            (commitmentAmountInWei = commitmentEntity[2]);
          return [4 /*yield*/, (0, sdkAsset_1.getAssetCode)(commitmentNumericAssetType)];
        case 2:
          commitmentAssetType = _a.sent();
          commitmentAmount = (0, bigNumber_1.fromWei)(
            (0, bigNumber_1.create)(commitmentAmountInWei.toString()),
            6,
          ).toFormat(6);
          responseMap.push({
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          calculatedFee = (0, bigNumber_1.fromWei)(
            (0, bigNumber_1.create)(expectedFee.toString()),
            6,
          ).toFormat(6);
...
var barToAbar = function (walletInfo, sids, receiverAxfrPublicKey) {
  return __awaiter(void 0, void 0, void 0, function () {
    var ledger,
      transactionBuilder,
      item,
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 11:
          ...
          if (memoError) {
            throw new Error(
              'Could not fetch memo data for sid "'.concat(sid, '", Error - ').concat(memoError.message),
            );
          }
          ownerMemo = void 0;
          assetRecord = void 0;
          try {
            ...
            throw new Error(
              'Could not get decode memo data or get assetRecord", Error - '.concat(error.message),
            );
          }
          ...
          try {
            transactionBuilder = transactionBuilder.add_operation_bar_to_abar(
              ...
              BigInt(sid),
              assetRecord,
              ownerMemo === null || ownerMemo === void 0 ? void 0 : ownerMemo.clone(),
            );
          } catch (error) {
        ...
        case 16:
          ...
          try {
            commitments =
              transactionBuilder === null || transactionBuilder === void 0
                ? void 0
                : transactionBuilder.get_commitments();
            console.log('🚀 ~ file: tripleMasking.ts ~ line 575 ~ commitments', commitments);
          } catch (err) {
            throw new Error('could not get a list of commitments strings "'.concat(err.message, '" '));
          }
          if (
            !((_a = commitments === null || commitments === void 0 ? void 0 : commitments.commitments) ===
              null || _a === void 0
              ? void 0
              : _a.length)
          ) {
          ...
          return [
            2 /*return*/,
            { transactionBuilder: transactionBuilder, barToAbarData: barToAbarData, sids: sids },
          ];
      }
    });
  });
...
var abarToBar = function (anonKeysSender, receiverWalletInfo, ownedAbarToUseAsSource) {
  return __awaiter(void 0, void 0, void 0, function () {
        ...
        case 4:
          ...
          return [
            2 /*return*/,
            {
              ...
              receiverWalletInfo: receiverWalletInfo,
            },
          ];
      }
    });
...
var isNullifierHashSpent = function (hash) {
  return __awaiter(void 0, void 0, void 0, function () {
    var checkSpentResult, checkSpentResponse, checkSpentError;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, Network.checkNullifierHashSpent(hash)];
        case 1:
          checkSpentResult = _a.sent();
          (checkSpentResponse = checkSpentResult.response), (checkSpentError = checkSpentResult.error);
          if (checkSpentError) {
            throw new Error(
              'Could not check if hash "'
                .concat(hash, ' is spent", Error - ')
                .concat(checkSpentError.message),
            );
          }
          if (checkSpentResponse === undefined) {
            throw new Error(
              'Could not check if hash "'.concat(hash, ' is spent", Error - Response is undefined'),
            );
          }
...
var getNullifierHashesFromCommitments = function (anonKeys, givenCommitmentsList) {
  return __awaiter(void 0, void 0, void 0, function () {
    var axfrSpendKey,
      axfrPublicKey,
      nullifierHashes,
      _i,
      givenCommitmentsList_1,
      givenCommitment,
      ownedAbarsResponse,
      error_11,
      ownedAbarItem,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 4:
          ...
          console.log(
            "getOwnedAbars for '"
              .concat(axfrPublicKey, "'->'")
              .concat(givenCommitment, "' returned an error. ")
              .concat(error_11.message),
            console.log('Full Error', error_11),
          );
          return [3 /*break*/, 7];
        case 5:
...
var getUnspentAbars = function (anonKeys, givenCommitmentsList) {
  return __awaiter(void 0, void 0, void 0, function () {
    var axfrSpendKey,
      axfrPublicKey,
      unspentAbars,
      _i,
      givenCommitmentsList_2,
      givenCommitment,
      ownedAbarsResponse,
      error_12,
      ownedAbarItem,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 4:
          ...
          console.log(
            "getOwnedAbars for '"
              .concat(axfrPublicKey, "'->'")
              .concat(givenCommitment, "' returned an error. ")
              .concat(error_12.message),
            console.log('Full Error', error_12),
          );
          return [3 /*break*/, 8];
        case 5:
          ownedAbarItem = ownedAbarsResponse[0];
        ...
        case 8:
          ...
          return [3 /*break*/, 1];
        case 9:
          return [2 /*return*/, unspentAbars];
      }
    });
  });
};
exports.getUnspentAbars = getUnspentAbars;
var getSpentAbars = function (anonKeys, givenCommitmentsList) {
  return __awaiter(void 0, void 0, void 0, function () {
    var axfrSpendKey,
      axfrPublicKey,
      spentAbars,
      _i,
      givenCommitmentsList_3,
      givenCommitment,
      ownedAbarsResponse,
      error_13,
      ownedAbarItem,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 4:
          ...
          console.log(
            "getOwnedAbars for '"
              .concat(axfrPublicKey, "'->'")
              .concat(givenCommitment, "' returned an error. ")
              .concat(error_13.message),
            console.log('Full Error', error_13),
          );
          return [3 /*break*/, 8];
        case 5:
          ownedAbarItem = ownedAbarsResponse[0];
        ...
        case 8:
          ...
          return [3 /*break*/, 1];
        case 9:
          return [2 /*return*/, spentAbars];
      }
    });
  });
};
exports.getSpentAbars = getSpentAbars;
var openAbar = function (abar, anonKeys) {
  return __awaiter(void 0, void 0, void 0, function () {
    var ledger,
      abarData,
      atxoSid,
...
var getBalanceMaps = function (unspentAbars, anonKeys) {
  return __awaiter(void 0, void 0, void 0, function () {
    var assetDetailsMap,
      balancesMap,
      atxoMap,
...
var getBalance = function (anonKeys, givenCommitmentsList) {
  return __awaiter(void 0, void 0, void 0, function () {
    var unspentAbars, balances;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, (0, exports.getUnspentAbars)(anonKeys, givenCommitmentsList)];
        case 1:
...
var getSpentBalance = function (anonKeys, givenCommitmentsList) {
  return __awaiter(void 0, void 0, void 0, function () {
    var unspentAbars, balances;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, (0, exports.getSpentAbars)(anonKeys, givenCommitmentsList)];
        case 1:
          unspentAbars = _a.sent();
          return [4 /*yield*/, (0, exports.getAbarBalance)(unspentAbars, anonKeys)];
        case 2:
...
var getAllAbarBalances = function (anonKeys, givenCommitmentsList) {
  return __awaiter(void 0, void 0, void 0, function () {
    var spentBalances, unSpentBalances;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, (0, exports.getSpentBalance)(anonKeys, givenCommitmentsList)];
        case 1:
...
var getAbarBalance = function (unspentAbars, anonKeys) {
  return __awaiter(void 0, void 0, void 0, function () {
    var maps,
      axfrPublicKey,
      assetDetailsMap,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          maps = _a.sent();
          axfrPublicKey = anonKeys.axfrPublicKey;
          (assetDetailsMap = maps.assetDetailsMap),
            (balancesMap = maps.balancesMap),
            (usedAssets = maps.usedAssets);
          balances = [];
...
var getOwnedAbars = function (givenCommitment) {
  return __awaiter(void 0, void 0, void 0, function () {
    var getOwnedAbarsResponse, ownedAbarsResponse, error, atxoSid, ownedAbar, abar;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, Network.getOwnedAbars(givenCommitment)];
        case 1:
          getOwnedAbarsResponse = _a.sent();
          console.log(
            '\uD83D\uDE80 ~ file: tripleMasking.ts ~ line 926 ~ getOwnedAbars ~ getOwnedAbarsResponse for commitment ' +
              givenCommitment,
...
var genNullifierHash = function (atxoSid, ownedAbar, axfrSpendKey) {
  return __awaiter(void 0, void 0, void 0, function () {
    var ledger,
      abarOwnerMemoResult,
      myMemoData,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          if (memoError) {
            throw new Error(
              'Could not fetch abar memo data for sid (genNullifierHash) "'
                .concat(atxoSid, '", Error - ')
                .concat(memoError.message),
            );
          }
...
var getSendAtxo = function (code, amount, commitments, anonKeys) {
  return __awaiter(void 0, void 0, void 0, function () {
    var result,
      unspentAbars,
      balancesMaps,
