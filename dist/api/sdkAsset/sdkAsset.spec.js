...
describe('sdkAsset', function () {
    ...
    describe('defineAsset', function () {
        it('defines asset', function () { return __awaiter(void 0, void 0, void 0, function () {
            var walletInfo, getSidsUrl, postUrl, globalStateUrl, myResponse, globalState, utxoDataCache, assetCode, givenAsset, param, memo, traceable, transferable, updatable, code, maxNumbers, decimals, assetRules, handle;
