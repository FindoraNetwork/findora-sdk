...
exports.getAssetDetails =
  exports.issueAsset =
  exports.defineAsset =
  exports.getIssueAssetTransactionBuilder =
  exports.getDefineAssetTransactionBuilder =
  exports.getAssetRules =
  exports.getDefaultAssetRules =
  exports.getAssetCodeToSend =
  exports.getDerivedAssetCode =
  exports.getRandomAssetCode =
  exports.getAssetCode =
  exports.getFraPublicKey =
  exports.getBarToAbarMinimalFee =
  exports.getMinimalFee =
  exports.getFraAssetCode =
    void 0;
...
var getBarToAbarMinimalFee = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var ledger, fee;
    return __generator(this, function (_a) {
      switch (_a.label) {
...
var getDerivedAssetCode = function (assetCode) {
  return __awaiter(void 0, void 0, void 0, function () {
...
var getAssetCodeToSend = function (assetCode) {
  return __awaiter(void 0, void 0, void 0, function () {
...
var getDefaultAssetRules = function () {
  return __awaiter(void 0, void 0, void 0, function () {
...
var getAssetRules = function (newAssetRules) {
  return __awaiter(void 0, void 0, void 0, function () {
    var defaultAssetRules,
      ledger,
      transferable,
      updatable,
      decimals,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          ledger = _a.sent();
          (transferable = newAssetRules.transferable),
            (updatable = newAssetRules.updatable),
            (decimals = newAssetRules.decimals),
            (traceable = newAssetRules.traceable),
            (maxNumbers = newAssetRules.maxNumbers);
          assetRules = ledger.AssetRules.new()
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          e = error_1;
          throw new Error(
            'Could not get transactionBuilder from "getTransactionBuilder", Error: "' + e.message + '"',
          );
        case 3:
          definitionTransaction = transactionBuilder.add_operation_create_asset(
            walletKeypair,
            assetMemo,
            assetName,
            assetRules,
...
var getIssueAssetTransactionBuilder = function (
  walletKeypair,
  assetName,
  amountToIssue,
  assetBlindRules,
  ...
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, Builder.getBlockHeight()];
        case 1:
          blockCount = _a.sent();
          utxoNumbers = BigInt((0, bigNumber_1.toWei)(amountToIssue, assetDecimals).toString());
          blindIsAmount =
            assetBlindRules === null || assetBlindRules === void 0 ? void 0 : assetBlindRules.isAmountBlind;
          _a.label = 2;
        case 2:
          _a.trys.push([2, 4, , 5]);
          return [4 /*yield*/, Builder.getTransactionBuilder()];
        ...
        case 5:
          definitionTransaction = transactionBuilder.add_basic_issue_asset(
            walletKeypair,
            assetName,
            blockCount,
            utxoNumbers,
 ...
 */
var defineAsset = function (walletInfo, assetName, assetMemo, newAssetRules) {
  return __awaiter(void 0, void 0, void 0, function () {
    var assetRules, transferOperationBuilder, receivedTransferOperation, e, transactionBuilder, err_1, e, e;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, (0, exports.getAssetRules)(newAssetRules)];
        case 1:
          assetRules = _a.sent();
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            (0, exports.getDefineAssetTransactionBuilder)(
              walletInfo.keypair,
              assetName,
              assetRules,
              assetMemo,
 ...
 * @returns An instance of **TransactionBuilder** from {@link https://git@github.com:FindoraNetwork/wasm-js-bindings.git | Ledger }
 */
var issueAsset = function (walletInfo, assetName, amountToIssue, assetBlindRules, assetDecimals) {
  return __awaiter(void 0, void 0, void 0, function () {
    var asset,
      decimals,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, (0, exports.getAssetDetails)(assetName)];
        case 1:
          asset = _a.sent();
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            (0, exports.getIssueAssetTransactionBuilder)(
              walletInfo.keypair,
              assetName,
              amountToIssue,
              assetBlindRules,
...
var getAssetDetails = function (assetCode) {
  return __awaiter(void 0, void 0, void 0, function () {
      ...
      switch (_a.label) {
        ...
        case 4:
          ...
          assetDetails = {
            ...
            memo: asset.memo,
            assetRules: __assign(
              __assign({}, asset_1.DEFAULT_ASSET_RULES),
              asset === null || asset === void 0 ? void 0 : asset.asset_rules,
            ),
            numbers: BigInt(0),
            name: '',
          };
