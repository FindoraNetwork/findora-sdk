...
export declare const createTestBars: (
  givenSenderOne?: string | undefined,
  amount?: string,
  iterations?: number,
) => Promise<true>;
export declare const barToAbar: (
  givenSenderOne?: string | undefined,
  AnonKeys?: FindoraWallet.FormattedAnonKeys | undefined,
  givenSids?: number[] | undefined,
  givenBalanceChange?: string | undefined,
  givenAssetCode?: string | undefined,
