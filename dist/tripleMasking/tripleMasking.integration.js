...
var barToAbarBalances = function (walletInfo, 
// anonKeys: FindoraWallet.FormattedAnonKeys,
anonKeys, givenCommitments, balance, givenBalanceChange, assetCode, extraSpent) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                ...
                (0, utils_1.log)('ABAR balance for anon public key ', anonKeys.publickey, ' is ', anonBalanceValue, " ".concat(assetCode));
...
var validateSpent = function (
// AnonKeys: FindoraWallet.FormattedAnonKeys,
AnonKeys, givenCommitments) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                axfrKeyPair = anonKeys.privateStr;
...
var barToAbar = function (givenSenderOne, AnonKeys, 
// AnonKeys?: FindoraWallet.FormattedAnonKeys,
givenSids, givenBalanceChange, givenAssetCode, isBalanceCheck) {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 13:
                    ...
                    return [4 /*yield*/, api_1.TripleMasking.barToAbar(walletInfo, sids, anonKeys.publickey)];
                case 14:
...
givenAnonKeysReceiver, amountToSend) {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 8:
                ...
                return [4 /*yield*/, api_1.TripleMasking.abarToAbar(anonKeysSender, anonKeysReceiver.publickey, '8', [ownedAbarToUseAsSource])];
            case 9:
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 20:
                _i++;
                return [3 /*break*/, 18];
            case 21: return [4 /*yield*/, api_1.TripleMasking.abarToAbar(anonKeysSender, anonKeysReceiver.publickey, '2', additionalOwnedAbarItems)];
            case 22:
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 7:
                ...
                amountToSend = '23.15';
                return [4 /*yield*/, api_1.TripleMasking.getAbarToAbarAmountPayload(anonKeysSender, anonKeysReceiver.publickey, amountToSend, assetCodeToUse, givenCommitmentsListSender)];
            case 8:
                payload = _d.sent();
                totalExpectedFee = payload.additionalAmountForFee;
                (0, utils_1.log)('totalExpectedFee for abar to abar', totalExpectedFee);
                return [4 /*yield*/, api_1.TripleMasking.abarToAbarAmount(anonKeysSender, anonKeysReceiver.publickey, amountToSend, assetCodeToUse, givenCommitmentsListSender)];
            case 9:
...
var abarToBarWithHiddenAmountAndType = function () { return __awaiter(void 0, void 0, void 0, function () {
    var anonKeysSender, senderWalletInfo, pkey, fraAssetCode, walletInfo, fraAssetSids, fAssetSidOne, fAssetSidTwo, fAssetSidThree, givenCommitments, givenCommitment, givenCommitmentOne, balance, ownedAbarsResponse, ownedAbarToUseAsSource, ownedAbarsResponseOne, ownedAbarToUseAsSourceOne, hideAmount, hideAssetType, transactionBuilder, resultHandle, balanceNew, balanceChangeF, givenBalanceChange, realBalanceChange, expectedBalanceChange, expectedBarBalanceChange, message, anonBalances, err, anonBalSpent, anonBalanceValue, realAnonBalanceValue, message;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
            ...
            case 10:
                ...
                hideAmount = true;
                hideAssetType = true;
                return [4 /*yield*/, api_1.TripleMasking.abarToBar(anonKeysSender, walletInfo.publickey, [ownedAbarToUseAsSource, ownedAbarToUseAsSourceOne], hideAmount, hideAssetType)];
            case 11:
                transactionBuilder = (_c.sent()).transactionBuilder;
                return [4 /*yield*/, api_1.Transaction.submitTransaction(transactionBuilder)];
            case 12:
