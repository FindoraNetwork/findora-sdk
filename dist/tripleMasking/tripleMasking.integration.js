    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                ...
                (0, utils_1.log)("will wait for ".concat(waitingTimeBeforeCheckTxStatus, "ms and then check balances for both sender and receiver commitments"));
                // await sleep(waitingTimeBeforeCheckTxStatus);
                return [4 /*yield*/, (0, testHelpers_1.waitForBlockChange)()];
            case 5:
                // await sleep(waitingTimeBeforeCheckTxStatus);
        ...
        switch (_d.label) {
            ...
            case 10:
                ...
                if (balanceChange != 419 && balanceChange != 420) {
                    err = "ERROR BAR balance does not match expected value of ".concat(balanceChange);
                    (0, utils_1.log)(err);
                    return [2 /*return*/, err];
                }
