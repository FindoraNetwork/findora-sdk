...
exports.barToAbarAmount =
  exports.abarToBarFraSendAmount =
  exports.abarToBarCustomSendAmount =
  exports.abarToBar =
  exports.abarToAbarCustomMultipleFraAtxoForFeeSendAmount =
  exports.abarToAbarFraMultipleFraAtxoForFeeSendAmount =
  exports.abarToAbarMulti =
  exports.abarToAbar =
  exports.barToAbar =
  exports.createTestBars =
  exports.getSidsForSingleAsset =
  exports.validateSpent =
  exports.issueCustomAsset =
  exports.defineCustomAsset =
  exports.createNewKeypair =
  exports.getAnonKeys =
  exports.getDerivedAssetCode =
  exports.getRandomAssetCode =
    void 0;
...
var walletKeys = envConfig.keys,
  envHostUrl = envConfig.hostUrl;
var sdkEnv = {
  hostUrl: envHostUrl,
...
var getRandomAssetCode = function () {
...
var getDerivedAssetCode = function (asset1Code) {
  return __awaiter(void 0, void 0, void 0, function () {
...
var defineCustomAsset = function (senderOne, assetCode) {
  return __awaiter(void 0, void 0, void 0, function () {
...
var issueCustomAsset = function (senderOne, assetCode, derivedAssetCode, amount) {
  return __awaiter(void 0, void 0, void 0, function () {
...
var barToAbarBalances = function (
  walletInfo,
  anonKeys,
  givenCommitments,
  balance,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          balanceNew = _a.sent();
          (0,
          utils_1.log)('Old BAR balance for public key ', walletInfo.address, ' is ', balance, ' ' + assetCode);
          (0,
          utils_1.log)('New BAR balance for public key ', walletInfo.address, ' is ', balanceNew, ' ' + assetCode);
          balanceChangeF = parseFloat(balance.replace(/,/g, '')) - parseFloat(balanceNew.replace(/,/g, ''));
          (0,
          utils_1.log)('Change of BAR balance for public key ', walletInfo.address, ' is ', balanceChangeF, ' ' + assetCode);
          ...
          if (!realBalanceChange.isEqualTo(expectedBarBalanceChange)) {
            message =
              'BAR balance of ' +
              realBalanceChange.toString() +
              ' does not match expected value ' +
              expectedBarBalanceChange.toString();
        ...
        case 4:
          ...
          (0,
          utils_1.log)('ABAR balance for anon public key ', anonKeys.axfrPublicKey, ' is ', anonBalanceValue, ' ' + assetCode);
          realAnonBalanceValue = (0, bigNumber_1.create)(anonBalanceValue);
          if (!realAnonBalanceValue.isEqualTo(expectedBalanceChange)) {
            message =
              'ABAR balance does not match expected value, real is ' +
              realAnonBalanceValue.toString() +
              ' and expected is ' +
...
var validateSpent = function (AnonKeys, givenCommitments) {
  return __awaiter(void 0, void 0, void 0, function () {
    var anonKeys,
      axfrKeyPair,
      _i,
...
var getSidsForSingleAsset = function (senderOne, assetCode) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          ...
          return [
            2 /*return*/,
            customAssetSids.sort(function (a, b) {
              return a - b;
            }),
          ];
      }
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 6:
          ...
          return [
            4 /*yield*/,
            api_1.Transaction.sendToAddress(
              walletInfo,
    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        ...
        case 11:
          ...
          fraSid = fraSids.sort(function (a, b) {
            return a - b;
          })[0];
          sids = [fraSid];
        ...
        case 14:
          (_c = _d.sent()),
            (transactionBuilder = _c.transactionBuilder),
            (barToAbarData = _c.barToAbarData),
            (usedSids = _c.sids);
        ...
        case 16:
          ...
          return [
            4 /*yield*/,
            barToAbarBalances(walletInfo, anonKeys, givenCommitments, balance, balanceChange, assetCode),
          ];
        case 17:
          _d.sent();
          _d.label = 18;
        case 18:
          return [2 /*return*/, givenCommitments];
      }
    });
  });
};
exports.barToAbar = barToAbar;
var abarToAbar = function (givenAnonKeysReceiver) {
  return __awaiter(void 0, void 0, void 0, function () {
    var senderWalletInfo,
      senderOne,
      anonKeysSender,
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          (0,
          utils_1.log)('//////////////// Single Asset Anonymous Transfer (ABAR To ABAR) //////////////// ');
          return [4 /*yield*/, (0, exports.createNewKeypair)()];
        case 1:
        ...
        case 3:
          ...
          anonKeysReceiver = givenAnonKeysReceiver
            ? __assign({}, givenAnonKeysReceiver)
            : __assign({}, generatedAnonKeysReceiver);
          return [4 /*yield*/, api_1.Asset.getFraAssetCode()];
        case 4:
        ...
        case 6:
          ...
          return [
            4 /*yield*/,
            (0, exports.barToAbar)(senderOne, anonKeysSender, [fraSid], '10', fraAssetCode),
          ];
        case 7:
        ...
        case 8:
          ...
          return [
            4 /*yield*/,
            api_1.TripleMasking.abarToAbar(anonKeysSender, anonKeysReceiver.axfrPublicKey, '8', [
              ownedAbarToUseAsSource,
            ]),
          ];
        case 9:
          (_a = _b.sent()),
            (anonTransferOperationBuilder = _a.anonTransferOperationBuilder),
            (abarToAbarData = _a.abarToAbarData);
        ...
        case 10:
          ...
          (0,
          utils_1.log)('will wait for the next block and then check balances for both sender and receiver commitments');
        ...
        case 11:
          ...
          for (_i = 0, commitmentsMap_1 = commitmentsMap; _i < commitmentsMap_1.length; _i++) {
            ...
            (commitmentKey = commitmentsMapEntry.commitmentKey),
              (commitmentAxfrPublicKey = commitmentsMapEntry.commitmentAxfrPublicKey);
          ...
          (0,
          utils_1.log)('🚀 ~ abarToAbar ~ retrievedCommitmentsListReceiver', retrievedCommitmentsListReceiver);
        ...
        case 12:
          ...
          return [
            4 /*yield*/,
            api_1.TripleMasking.getBalance(anonKeysReceiver, retrievedCommitmentsListReceiver),
          ];
        case 13:
          ...
          if (!realBalanceSender.isEqualTo(expectedBalanceSender)) {
            message =
              'sender ABAR balance ' +
              expectedBalanceSender.toString() +
              ' does not match expected ' +
              realBalanceSender.toString();
            (0, utils_1.log)(message);
            throw new Error(message);
          }
          if (!realBalanceReceiver.isEqualTo(expectedBalanceReceiver)) {
            message =
              'receiver ABAR balance ' +
              expectedBalanceReceiver.toString() +
              ' does not match expected ' +
              realBalanceReceiver.toString();
            (0, utils_1.log)(message);
            throw new Error(message);
          }
...
var abarToAbarMulti = function (givenAnonKeysReceiver) {
  return __awaiter(void 0, void 0, void 0, function () {
    var anonKeysSender,
      generatedAnonKeysReceiver,
      anonKeysReceiver,
      ...
      ownedAbarToUseAsSource,
      _i,
      givenCommitmentsToPayFee_1,
      givenCommitmentToPayFee,
      ownedAbarsResponseFee,
      additionalOwnedAbarItem,
      _a,
      anonTransferOperationBuilder,
      abarToAbarData,
      resultHandle,
      ...
      minimumExpectedSenderFraBalance,
      message,
      senderCustomBalances,
      message,
      sendercustomSpent,
      customSpentSender,
      customBalanceSenderConverted,
      expectedSenderCustomBalance,
      message,
      balancesReceiver,
      customBalReceive,
      customBalanceReceiver,
      customBalanceReceiverConverted,
      expectedReceiverCustomBalance,
      message;
    var _c, _d;
    return __generator(this, function (_e) {
      switch (_e.label) {
        ...
        case 12:
          ...
          customAssetSid = customAssetSids.sort(function (a, b) {
            return b - a;
          })[0];
          return [
            4 /*yield*/,
            (0, exports.barToAbar)(senderOne, anonKeysSender, [customAssetSid], '20', derivedAssetCode),
          ];
        case 13:
        ...
        case 16:
          ...
          (0,
          utils_1.log)('🚀 ~ abarToAbarMulti ~ Given ABAR commitments To Transfer', givenCommitmentsToTransfer);
          (0, utils_1.log)('🚀 ~ abarToAbarMulti ~ Given FRA ABAR Commitment', givenCommitmentsToPayFee);
          givenCommitmentsListSender = __spreadArray(
            [givenCommitmentsToTransfer[0]],
            givenCommitmentsToPayFee,
            true,
          );
          return [4 /*yield*/, api_1.TripleMasking.getBalance(anonKeysSender, givenCommitmentsListSender)];
        case 17:
          ...
          (0,
          utils_1.log)('🚀 ~ abarToAbarMulti ~ balancesSenderBefore', JSON.stringify(balancesSenderBefore, null, 2));
          additionalOwnedAbarItems = [];
          return [4 /*yield*/, api_1.TripleMasking.getOwnedAbars(givenCommitmentsToTransfer[0])];
        case 18:
        ...
        case 22:
          return [
            4 /*yield*/,
            api_1.TripleMasking.abarToAbar(
              anonKeysSender,
        ...
        case 25:
          ...
          (0,
          utils_1.log)('🚀 ~ abarToAbarMulti ~ retrievedCommitmentsListReceiver', retrievedCommitmentsListReceiver);
        ...
        case 26:
          ...
          return [
            4 /*yield*/,
            api_1.TripleMasking.getAllAbarBalances(anonKeysSender, givenCommitmentsToTransfer),
          ];
        case 27:
          senderCustomBalances = _e.sent();
          console.log(
            '🚀 ~ abarToAbarMulti ~ senderCustomBalances',
            JSON.stringify(senderCustomBalances, null, 2),
          );
          if (
            !((_d =
              (_c =
                senderCustomBalances === null || senderCustomBalances === void 0
                  ? void 0
                  : senderCustomBalances.spentBalances) === null || _c === void 0
                ? void 0
                : _c.balances) === null || _d === void 0
              ? void 0
              : _d.length)
          ) {
...
var abarToAbarFraMultipleFraAtxoForFeeSendAmount = function (givenAnonKeysReceiver) {
  return __awaiter(void 0, void 0, void 0, function () {
    var generatedAnonKeysReceiver,
      ...
      commitmentKey,
      commitmentAxfrPublicKey,
      balancesReceiverAfter,
      receiverExpectedFraAbarBalanceTransfer,
      fraAbarAmountAfterTransfer,
      realReceiverFraAbarBalance,
      isReceiverHasProperFraBalanceAfter,
      balancesSenderAfter,
      senderExpectedFraAbarBalanceTransfer,
      fraAbarAmountAfterTransferSender,
      realSenderFraAbarBalanceAfter,
      isSenderHasProperFraBalanceAfter;
    var _b, _c;
    return __generator(this, function (_d) {
      switch (_d.label) {
        case 0:
        ...
        case 6:
          ...
          (fAssetSidOne = fraAssetSids[0]),
            (fAssetSidTwo = fraAssetSids[1]),
            (fAssetSidThree = fraAssetSids[2]),
            (fAssetSidFour = fraAssetSids[3]);
          return [
            4 /*yield*/,
            (0, exports.barToAbar)(
              pkey,
        ...
        case 8:
          ...
          return [
            4 /*yield*/,
            api_1.TripleMasking.getAbarToAbarAmountPayload(
              anonKeysSender,
              anonKeysReceiver.axfrPublicKey,
              amountToSend,
              assetCodeToUse,
        ...
        case 9:
          ...
          return [
            4 /*yield*/,
            api_1.TripleMasking.abarToAbarAmount(
              anonKeysSender,
              anonKeysReceiver.axfrPublicKey,
              amountToSend,
              assetCodeToUse,
        ...
        case 12:
          ...
          return [
            4 /*yield*/,
            api_1.TripleMasking.getBalance(anonKeysReceiver, retrivedCommitmentsListReceiver),
          ];
        case 13:
          balancesReceiverAfter = _d.sent();
          (0,
          utils_1.log)('receiver balances after abar to abar', JSON.stringify(balancesReceiverAfter, null, 2));
          receiverExpectedFraAbarBalanceTransfer = (0, bigNumber_1.create)(amountToSend);
          fraAbarAmountAfterTransfer =
            (_b =
              balancesReceiverAfter === null || balancesReceiverAfter === void 0
                ? void 0
                : balancesReceiverAfter.balances.find(function (element) {
                    return element.assetType === assetCodeToUse;
                  })) === null || _b === void 0
              ? void 0
              : _b.amount;
          if (!fraAbarAmountAfterTransfer) {
            throw new Error(
              'Receiver is expected to have ' +
                receiverExpectedFraAbarBalanceTransfer.toString() +
                " ABAR FRA but it has '" +
                fraAbarAmountAfterTransfer +
                "'",
            );
          ...
          isReceiverHasProperFraBalanceAfter = realReceiverFraAbarBalance.isEqualTo(
            receiverExpectedFraAbarBalanceTransfer,
          );
          if (!isReceiverHasProperFraBalanceAfter) {
            throw new Error(
              'Receiver is expected to have ' +
                receiverExpectedFraAbarBalanceTransfer.toString() +
                " ABAR FRA but it has '" +
                realReceiverFraAbarBalance.toString() +
                "'",
            );
          }
          return [4 /*yield*/, api_1.TripleMasking.getBalance(anonKeysSender, givenCommitmentsListSender)];
        case 14:
          ...
          (0,
          utils_1.log)('sender balances after abar to abar', JSON.stringify(balancesSenderAfter, null, 2));
          senderExpectedFraAbarBalanceTransfer = (0, bigNumber_1.create)('15.65');
          fraAbarAmountAfterTransferSender =
            (_c =
              balancesSenderAfter === null || balancesSenderAfter === void 0
                ? void 0
                : balancesSenderAfter.balances.find(function (element) {
                    return element.assetType === assetCodeToUse;
                  })) === null || _c === void 0
              ? void 0
              : _c.amount;
          if (!fraAbarAmountAfterTransferSender) {
            throw new Error(
              'Sender is expected to have ' +
                senderExpectedFraAbarBalanceTransfer.toString() +
                " ABAR FRA but it has '" +
                fraAbarAmountAfterTransferSender +
                "'",
            );
          ...
          isSenderHasProperFraBalanceAfter = realSenderFraAbarBalanceAfter.isGreaterThanOrEqualTo(
            senderExpectedFraAbarBalanceTransfer,
          );
          if (!isSenderHasProperFraBalanceAfter) {
            throw new Error(
              'Sender is expected to have at least ' +
                senderExpectedFraAbarBalanceTransfer.toString() +
                " ABAR FRA but it has '" +
                realSenderFraAbarBalanceAfter.toString() +
                "'",
            );
          }
          return [2 /*return*/, true];
...
var abarToAbarCustomMultipleFraAtxoForFeeSendAmount = function (givenAnonKeysReceiver) {
  return __awaiter(void 0, void 0, void 0, function () {
    var generatedAnonKeysReceiver,
      anonKeysReceiver,
      anonKeysSender,
      ...
      customAbarAmountAfterTransfer,
      realReceiverCustomAbarBalance,
      isReceiverHasProperCustomBalanceAfter,
      balancesSenderAfter,
      senderExpectedFraAbarBalanceTransfer,
      fraAbarAmountAfterTransferSender,
      realSenderFraAbarBalanceAfter,
      ...
      customAbarAmountAfterTransferSender,
      realSenderCustomAbarBalanceAfter,
      isSenderHasProperCustomBalanceAfter;
    var _b, _c, _d;
    return __generator(this, function (_e) {
      switch (_e.label) {
        case 0:
        ...
        case 12:
          ...
          (0,
          utils_1.log)('sender bar "' + assetCodeToUse + '" assetBalance before transfer (after issuing the asset)', assetBalance);
        ...
        case 13:
          ...
          return [
            ...
            (0, exports.barToAbar)(
              pkey,
              anonKeysSender,
              __spreadArray([], customAssetSids, true),
              '35',
              derivedAssetCode,
            ),
          ];
        ...
        case 17:
          _e.sent();
          givenCommitmentsListSender = __spreadArray(
            __spreadArray([], customAssetCommitmentsList, true),
            fraAssetCommitmentsList,
            true,
          );
          (0, utils_1.log)('////////////////////// bar to abar is done, sending abar to abar //////////////');
        ...
        case 22:
          ...
          if (!customAbarAmountAfterTransfer) {
            throw new Error(
              'Receiver is expected to have ' +
                receiverExpectedCustomAbarBalanceTransfer.toString() +
                " ABAR custom but it has '" +
                customAbarAmountAfterTransfer +
                "'",
            );
          }
          realReceiverCustomAbarBalance = (0, bigNumber_1.create)(customAbarAmountAfterTransfer);
          isReceiverHasProperCustomBalanceAfter = realReceiverCustomAbarBalance.isEqualTo(
            receiverExpectedCustomAbarBalanceTransfer,
          );
          if (!isReceiverHasProperCustomBalanceAfter) {
            throw new Error(
              'Receiver is expected to have ' +
                receiverExpectedCustomAbarBalanceTransfer.toString() +
                " ABAR custom but it has '" +
                realReceiverCustomAbarBalance.toString() +
                "'",
            );
          }
          return [4 /*yield*/, api_1.TripleMasking.getBalance(anonKeysSender, givenCommitmentsListSender)];
        case 23:
          ...
          fraAbarAmountAfterTransferSender =
            (_c =
              balancesSenderAfter === null || balancesSenderAfter === void 0
                ? void 0
                : balancesSenderAfter.balances.find(function (element) {
                    return element.assetType === fraAssetCode;
                  })) === null || _c === void 0
              ? void 0
              : _c.amount;
          if (!fraAbarAmountAfterTransferSender) {
          ...
          if (!customAbarAmountAfterTransferSender) {
            throw new Error(
              'Sender is expected to have ' +
                senderExpectedCustomAbarBalanceTransfer.toString() +
                " custom ABAR but it has '" +
                customAbarAmountAfterTransferSender +
                "'",
            );
          }
          realSenderCustomAbarBalanceAfter = (0, bigNumber_1.create)(customAbarAmountAfterTransferSender);
          isSenderHasProperCustomBalanceAfter = realSenderCustomAbarBalanceAfter.isEqualTo(
            senderExpectedCustomAbarBalanceTransfer,
          );
          if (!isSenderHasProperCustomBalanceAfter) {
            throw new Error(
              'Sender is expected to have ' +
                senderExpectedCustomAbarBalanceTransfer.toString() +
                " custom ABAR but it has '" +
                realSenderCustomAbarBalanceAfter.toString() +
                "'",
            );
          }
          return [2 /*return*/, true];
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 10:
          ...
          return [
            4 /*yield*/,
            api_1.TripleMasking.abarToBar(anonKeysSender, walletInfo.publickey, [
              ownedAbarToUseAsSource,
              ownedAbarToUseAsSourceOne,
            ]),
          ];
        ...
        case 14:
          ...
          (0,
          utils_1.log)('Change of BAR balance for public key ', walletInfo.address, ' is ', balanceChangeF, ' FRA');
        ...
        case 15:
          ...
          if (
            !((_b =
              (_a =
                anonBalances === null || anonBalances === void 0 ? void 0 : anonBalances.spentBalances) ===
                null || _a === void 0
                ? void 0
                : _a.balances) === null || _b === void 0
              ? void 0
              : _b.length)
          ) {
          ...
          return [
            4 /*yield*/,
            (0, exports.validateSpent)(anonKeysSender, [givenCommitment, givenCommitmentOne]),
          ];
        case 16:
          // it would throw an error if it is unspent
          _c.sent();
...
var abarToBarCustomSendAmount = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var anonKeysSender,
      senderWalletInfo,
      pkey,
      ...
      receiverAssetBalanceBeforeTransfer,
      isReceiverHasEmptyAssetBalanceBeforeTransfer,
      _a,
      transactionBuilder,
      ...
      fraAbarAmountAfterTransfer,
      customAbarAmountAfterTransfer,
      senderAssetBalanceAfterTransfer,
      isSenderHasProperAssetBalanceAfterTransfer,
      senderFraBalanceAfterTransfer,
      isSenderHasProperFraBalanceAfterTransfer,
      assetBalanceAfterAbarToBar,
      receiverAssetBalanceAfterTransfer,
      isReceiverHasProperAssetBalanceBeforeTransfer;
    var _b, _c;
    return __generator(this, function (_d) {
      switch (_d.label) {
        case 0:
        ...
        case 13:
          ...
          return [
            4 /*yield*/,
            (0, exports.barToAbar)(pkey, anonKeysSender, customAssetSids, '35', derivedAssetCode),
          ];
        case 14:
        ...
        case 19:
          ...
          isReceiverHasEmptyAssetBalanceBeforeTransfer = receiverAssetBalanceBeforeTransfer.isEqualTo(
            (0, bigNumber_1.create)('0'),
          );
          if (!isReceiverHasEmptyAssetBalanceBeforeTransfer) {
            throw new Error(
              'Receiver must have 0 balance of the asset but it has ' +
                receiverAssetBalanceBeforeTransfer.toString(),
            );
          }
          return [
            4 /*yield*/,
            api_1.TripleMasking.abarToBarAmount(
              anonKeysSender,
        ...
        case 20:
          (_a = _d.sent()),
            (transactionBuilder = _a.transactionBuilder),
            (remainderCommitements = _a.remainderCommitements),
            (spentCommitments = _a.spentCommitments);
          return [4 /*yield*/, api_1.Transaction.submitTransaction(transactionBuilder)];
        case 21:
          resultHandle = _d.sent();
          (0, utils_1.log)('abar to bar result handle!!', resultHandle);
        ...
        case 22:
          ...
          return [
            4 /*yield*/,
            api_1.TripleMasking.getBalance(
              anonKeysSender,
              __spreadArray(__spreadArray([], givenCommitmentsListSender, true), remainderCommitements, true),
            ),
          ];
        case 23:
          balancesSenderAfter = _d.sent();
          ...
          if (!fraAbarAmountAfterTransfer) {
            throw new Error(
              'Sender is expected to have ' +
                expectedFraAbarMinimumAmountAfterTransfer.toString() +
                " ABAR FRA but it has '" +
                fraAbarAmountAfterTransfer +
                "'",
            );
          ...
          if (!customAbarAmountAfterTransfer) {
            throw new Error(
              'Sender is expected to have ' +
                expectedCustomAbarAmountAfterTransfer.toString() +
                " ABAR custom asset but it has '" +
                customAbarAmountAfterTransfer +
                "'",
            );
          }
          senderAssetBalanceAfterTransfer = (0, bigNumber_1.create)(customAbarAmountAfterTransfer);
          isSenderHasProperAssetBalanceAfterTransfer = senderAssetBalanceAfterTransfer.isEqualTo(
            expectedCustomAbarAmountAfterTransfer,
          );
          if (!isSenderHasProperAssetBalanceAfterTransfer) {
            throw new Error(
              'Sender must have 22.5 balance of the asset but it has ' +
                senderAssetBalanceAfterTransfer.toString(),
            );
          }
          senderFraBalanceAfterTransfer = (0, bigNumber_1.create)(fraAbarAmountAfterTransfer);
          isSenderHasProperFraBalanceAfterTransfer = senderFraBalanceAfterTransfer.isGreaterThanOrEqualTo(
            expectedFraAbarMinimumAmountAfterTransfer,
          );
          if (!isSenderHasProperFraBalanceAfterTransfer) {
            throw new Error(
              'Sender must have at least ' +
                expectedFraAbarMinimumAmountAfterTransfer.toString() +
                ' balance but it has ' +
                senderFraBalanceAfterTransfer.toString(),
            );
          }
        ...
        case 24:
          ...
          isReceiverHasProperAssetBalanceBeforeTransfer = receiverAssetBalanceAfterTransfer.isEqualTo(
            (0, bigNumber_1.create)(amountToSend),
          );
          if (!isReceiverHasProperAssetBalanceBeforeTransfer) {
            throw new Error(
              'Receiver must have ' +
                amountToSend +
                ' balance of the asset but it has ' +
                receiverAssetBalanceAfterTransfer.toString(),
            );
          }
...
var abarToBarFraSendAmount = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var anonKeysSender,
      senderWalletInfo,
      pkey,
...
var barToAbarAmount = function (givenAnonKeysReceiver) {
  return __awaiter(void 0, void 0, void 0, function () {
    var generatedAnonKeysReceiver,
      anonKeysReceiver,
      senderWalletInfo,
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 6:
          ...
          return [
            4 /*yield*/,
            api_1.TripleMasking.barToAbarAmount(
              senderWalletInfo,
              amount,
              fraAssetCode,
              anonKeysReceiver.axfrPublicKey,
        ...
        case 7:
          (_a = _b.sent()),
            (transactionBuilder = _a.transactionBuilder),
            (barToAbarData = _a.barToAbarData),
            (usedSids = _a.sids);
          (0, utils_1.log)('🚀 ~ barToAbarData', JSON.stringify(barToAbarData, null, 2));
          (0, utils_1.log)('🚀 ~ usedSids', usedSids.join(','));
          return [4 /*yield*/, api_1.Transaction.submitTransaction(transactionBuilder)];
