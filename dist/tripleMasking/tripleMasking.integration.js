...
var createTestBars = function (givenSenderOne, amount, iterations) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var pkey, toPkeyMine, senderWalletInfo, formattedAmount, expectedBalance, walletInfo, toWalletInfo, fraCode, assetCode, assetBlindRules, i, transactionBuilder, resultHandle, additionalBlocksToWait, assetBalance, cleanedBalanceValue, realBalance, isFunded, errorMessage;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 8:
                    ...
                    additionalBlocksToWait = (i + 1) % 3 === 0 ? 2 : 0;
                    return [4 /*yield*/, (0, testHelpers_1.waitForBlockChange)(1 + additionalBlocksToWait)];
                case 9:
                    _a.sent();
                    _a.label = 10;
                case 10:
