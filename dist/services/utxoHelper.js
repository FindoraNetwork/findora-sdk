...
exports.addUtxoInputs =
  exports.getSendUtxo =
  exports.getSendUtxoLegacy =
  exports.addUtxo =
  exports.getUtxoItem =
  exports.decryptUtxoItem =
  exports.filterUtxoByCode =
    void 0;
...
var filterUtxoByCode = function (code, utxoDataList) {
  return utxoDataList.filter(function (assetItem) {
    var _a;
    return (
      ((_a = assetItem === null || assetItem === void 0 ? void 0 : assetItem.body) === null || _a === void 0
        ? void 0
        : _a.asset_type) === code
    );
  });
...
var decryptUtxoItem = function (sid, walletInfo, utxoData, memoData) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            ledger.open_client_asset_record(
              assetRecord,
...
var getUtxoItem = function (sid, walletInfo, cachedItem) {
  return __awaiter(void 0, void 0, void 0, function () {
          ...
          if (utxoError || !utxoData) {
            throw new Error(
              'Could not fetch utxo data for sid "'
                .concat(sid, '", Error - ')
                .concat(utxoError === null || utxoError === void 0 ? void 0 : utxoError.message),
            );
          }
          return [4 /*yield*/, Network.getOwnerMemo(sid)];
        case 2:
...
var addUtxo = function (walletInfo, addSids) {
  return __awaiter(void 0, void 0, void 0, function () {
    var utxoDataList,
      cacheDataToSave,
      utxoDataCache,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 6:
          ...
          return [
            4 /*yield*/,
            (0, exports.getUtxoItem)(
              sid,
              walletInfo,
              utxoDataCache === null || utxoDataCache === void 0 ? void 0 : utxoDataCache['sid_'.concat(sid)],
            ),
          ];
        case 7:
          item = _a.sent();
        ...
        case 8:
          ...
          err = error_3;
          console.log(
            'Could not process addUtxo for sid '.concat(sid, ', Details: "').concat(err.message, '"'),
          );
          return [3 /*break*/, 9];
        case 9:
          i++;
...
var addUtxoInputs = function (utxoSids) {
  return __awaiter(void 0, void 0, void 0, function () {
    var ledger,
      inputAmount,
      inputParametersList,
