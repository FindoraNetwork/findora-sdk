...
var ledgers = {
    nodeLedger: nodeLedger_1.default,
    webLedger: webLedger_1.default,
};
var getLedger = function (ledger) { return __awaiter(void 0, void 0, void 0, function () {
    var loadledgerModule, myLedger;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                loadledgerModule = ledgers[ledger];
                // const loadledgerModule = await import('./webLedger');
                console.log('loadledgerModule', loadledgerModule);
                return [4 /*yield*/, loadledgerModule()];
            case 1:
                myLedger = _a.sent();
