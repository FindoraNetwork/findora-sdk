...
export declare const getAssetTracingPolicies: (
  asset: FindoraWallet.IAsset,
) => Promise<
  import('findora-wallet-wasm/nodejs').TracingPolicies | import('findora-wallet-wasm/bundler').TracingPolicies
>;
export declare const getTransferOperation: (
  walletInfo: WalletKeypar,
  utxoInputs: UtxoInputsInfo,
  recieversInfo: ReciverInfo[],
  assetCode: string,
) => Promise<TransferOperationBuilder>;
export declare const getPayloadForFeeInputs: (
  walletInfo: WalletKeypar,
  utxoInputs: UtxoInputsInfo,
) => Promise<FeeInputPayloadType[]>;
export declare const buildTransferOperationWithFee: (
  walletInfo: WalletKeypar,
  assetBlindRules?:
    | {
...
export declare const getFeeInputs: (
  walletInfo: WalletKeypar,
  excludeSids: number[],
  isBarToAbar: boolean,
) => Promise<FeeInputs>;
export declare const buildTransferOperation: (
  walletInfo: WalletKeypar,
  recieversInfo: ReciverInfo[],
  assetCode: string,
) => Promise<TransferOperationBuilder>;
