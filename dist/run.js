    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 17:
          ...
          if (!txnSID) {
            console.log(
              '\uD83D\uDE80 ~ file: integration.ts ~ line 477 ~ delegateFraTransactionSubmit ~ Could not retrieve the transaction with a handle '.concat(
                resultHandle,
                '. Response was: ',
              ),
              transactionStatus,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 19:
          ...
          if (!txnSID) {
            console.log(
              '\uD83D\uDE80 ~ file: integration.ts ~ line 477 ~ delegateFraTransactionAndClaimRewards ~ Could not retrieve the transaction with a handle '.concat(
                resultHandle,
                '. Response was: ',
              ),
              transactionStatus,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 13:
          ...
          if (!txnSID) {
            console.log(
              '\uD83D\uDE80 ~ file: integration.ts ~ line 477 ~ unstakeFraTransactionSubmit ~ Could not retrieve the transaction with a handle '.concat(
                resultHandleSend,
                '. Response was: ',
              ),
              transactionStatusSend,
      ...
      switch (_b.label) {
        ...
        case 3:
          (_a = _b.sent()),
            (transactionBuilder = _a.transactionBuilder),
            (abarToBarData = _a.abarToBarData),
            (receiverXfrPublicKey = _a.receiverXfrPublicKey);
