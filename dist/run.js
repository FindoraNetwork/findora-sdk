...
var _a = process.env,
  ...
  _d = _a.PKEY_LOCAL_FAUCET_MNEMONIC_STRING_MINE1,
  PKEY_LOCAL_FAUCET_MNEMONIC_STRING_MINE1 = _d === void 0 ? '' : _d,
  _e = _a.PKEY_LOCAL_FAUCET_MNEMONIC_STRING_MINE2,
  PKEY_LOCAL_FAUCET_MNEMONIC_STRING_MINE2 = _e === void 0 ? '' : _e,
  _f = _a.PKEY_MINE2,
  PKEY_MINE2 = _f === void 0 ? '' : _f,
  _g = _a.PKEY_MINE3,
  PKEY_MINE3 = _g === void 0 ? '' : _g,
  _h = _a.PKEY_LOCAL_FAUCET,
  PKEY_LOCAL_FAUCET = _h === void 0 ? '' : _h,
  _j = _a.ENG_PKEY,
  ENG_PKEY = _j === void 0 ? '' : _j,
  _k = _a.PKEY_LOCAL_TRIPLE_MASKING,
  PKEY_LOCAL_TRIPLE_MASKING = _k === void 0 ? '' : _k,
  _l = _a.PKEY_LOCAL_FAUCET_MNEMONIC_STRING,
  PKEY_LOCAL_FAUCET_MNEMONIC_STRING = _l === void 0 ? '' : _l,
  _m = _a.M_STRING,
  M_STRING = _m === void 0 ? '' : _m,
  _o = _a.FRA_ADDRESS,
  FRA_ADDRESS = _o === void 0 ? '' : _o,
  _p = _a.ETH_PRIVATE,
  ETH_PRIVATE = _p === void 0 ? '' : _p,
  _q = _a.ETH_ADDRESS,
  ETH_ADDRESS = _q === void 0 ? '' : _q;
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            api_1.Keypair.restoreFromMnemonic(PKEY_LOCAL_FAUCET_MNEMONIC_STRING.split(' '), password, isFra),
          ];
        case 1:
          faucetWalletInfo = _a.sent();
          return [
            4 /*yield*/,
            api_1.Keypair.restoreFromMnemonic(
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          toWalletInfo = _a.sent();
          console.log(
            '🚀 ~ file: run.ts ~ line 397 ~ transferFraToSingleRecepient ~ toWalletInfo',
            toWalletInfo,
          );
          return [4 /*yield*/, api_1.Asset.getFraAssetCode()];
        case 3:
