 ...
 */
var defineCustomAsset = function () {
  return __awaiter(void 0, void 0, void 0, function () {
 ...
 */
var transferFraToSingleAddress = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var pkey,
      destAddress,
      password,
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 3:
          ...
          sortedSids = sids.sort(function (a, b) {
            return b - a;
          });
        ...
        case 4:
          (_a = _b.sent()),
            ...
            (usedSid = _a.sid);
          console.log(
            '🚀 ~ file: run.ts ~ line 1187 ~ barToAbarData',
        ...
        case 9:
          ...
          console.log(
            '🚀 ~ file: run.ts ~ line 1223 ~ barToAbar ~ ownedAbarsSaveResult',
            ownedAbarsSaveResult,
          );
          return [2 /*return*/];
      }
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            api_1.TripleMasking.abarToBar(anonKeysSender, walletInfo, ownedAbarToUseAsSource),
          ];
        case 3:
          (_a = _b.sent()),
            (transactionBuilder = _a.transactionBuilder),
