...
exports.createTestBarsMulti =
  exports.issueCustomAsset =
  exports.defineCustomAsset =
  exports.getSidsForAsset =
  exports.unstakeFraTransactionSubmit =
  exports.delegateFraTransactionAndClaimRewards =
  exports.delegateFraTransactionSubmit =
    void 0;
...
var _a = process.env,
  _b = _a.CUSTOM_ASSET_CODE,
  CUSTOM_ASSET_CODE = _b === void 0 ? '' : _b,
  _c = _a.PKEY_MINE,
  PKEY_MINE = _c === void 0 ? '' : _c,
  _d = _a.PKEY_LOCAL_FAUCET_MNEMONIC_STRING_MINE,
  PKEY_LOCAL_FAUCET_MNEMONIC_STRING_MINE = _d === void 0 ? '' : _d,
  _e = _a.PKEY_MINE2,
  PKEY_MINE2 = _e === void 0 ? '' : _e,
  _f = _a.PKEY_MINE3,
  PKEY_MINE3 = _f === void 0 ? '' : _f,
  _g = _a.PKEY_LOCAL_FAUCET,
  PKEY_LOCAL_FAUCET = _g === void 0 ? '' : _g,
  _h = _a.ENG_PKEY,
  ENG_PKEY = _h === void 0 ? '' : _h,
  _j = _a.PKEY_LOCAL_TRIPLE_MASKING,
  PKEY_LOCAL_TRIPLE_MASKING = _j === void 0 ? '' : _j,
  _k = _a.PKEY_LOCAL_FAUCET_MNEMONIC_STRING,
  PKEY_LOCAL_FAUCET_MNEMONIC_STRING = _k === void 0 ? '' : _k,
  _l = _a.M_STRING,
  M_STRING = _l === void 0 ? '' : _l,
  _m = _a.FRA_ADDRESS,
  FRA_ADDRESS = _m === void 0 ? '' : _m,
  _o = _a.ETH_PRIVATE,
  ETH_PRIVATE = _o === void 0 ? '' : _o,
  _p = _a.ETH_ADDRESS,
  ETH_ADDRESS = _p === void 0 ? '' : _p;
 ...
 */
var getCustomAssetBalance = function () {
  return __awaiter(void 0, void 0, void 0, function () {
 ...
 */
var defineCustomAssetRandom = function () {
  return __awaiter(void 0, void 0, void 0, function () {
 ...
 * Issue custom asset
 */
var issueCustomAssetGiven = function () {
  return __awaiter(void 0, void 0, void 0, function () {
 ...
 */
var getStateCommitment = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var stateCommitment;
    return __generator(this, function (_a) {
      switch (_a.label) {
 ...
 */
var getTransferBuilderOperation = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var ledger,
      password,
      pkey,
 ...
 */
var transferFraToSingleAddress = function (amount) {
  return __awaiter(void 0, void 0, void 0, function () {
    var pkey,
      password,
      walletInfo,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 10:
          ...
          sortedSidsNew = sids.sort(function (a, b) {
            return b - a;
          });
          console.log(
            '🚀 ~ file: run.ts ~ line 335 ~ transferFraToSingleAddress ~ sortedSidsNew',
            sortedSidsNew,
          );
          return [4 /*yield*/, api_1.Account.getBalance(walletInfo)];
        case 11:
...
var testTransferToYourself = function () {
  return __awaiter(void 0, void 0, void 0, function () {
 ...
 */
var transferFraToSingleRecepient = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var pkey,
      toPkeyMine2,
      password,
 ...
 */
var transferFraToMultipleRecepients = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var pkey,
      toPkeyMine2,
      toPkeyMine3,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            api_1.Transaction.sendToMany(walletInfo, recieversInfo, assetCode, assetBlindRules),
          ];
        case 5:
          transactionBuilder = _a.sent();
          return [4 /*yield*/, api_1.Transaction.submitTransaction(transactionBuilder)];
 ...
 */
var transferCustomAssetToSingleRecepient = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var pkey,
      toPkey,
      customAssetCode,
 ...
 */
var transferCustomAssetToMultipleRecepients = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var pkey,
      toPkeyMine2,
      toPkeyMine3,
 ...
 */
var getCustomAssetDetails = function () {
  return __awaiter(void 0, void 0, void 0, function () {
  ...
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        case 0:
          (_a = process.env),
            (AWS_ACCESS_KEY_ID = _a.AWS_ACCESS_KEY_ID),
            (AWS_SECRET_ACCESS_KEY = _a.AWS_SECRET_ACCESS_KEY),
            (UTXO_CACHE_BUCKET_NAME = _a.UTXO_CACHE_BUCKET_NAME),
            (UTXO_CACHE_KEY_NAME = _a.UTXO_CACHE_KEY_NAME);
        ...
        case 4:
          console.log(
            'readRes :)',
            (_b = readRes === null || readRes === void 0 ? void 0 : readRes.Body) === null || _b === void 0
              ? void 0
              : _b.toString(),
          );
          existingContent =
            (_c = readRes === null || readRes === void 0 ? void 0 : readRes.Body) === null || _c === void 0
              ? void 0
              : _c.toString('utf8');
...
var delegateFraTransactionSubmit = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var password,
      Ledger,
      pkey,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 14:
          resultHandle = _a.sent();
          console.log(
            '🚀 ~ file: run.ts ~ line 599 ~ delegateFraTransactionSubmit ~ resultHandle',
            resultHandle,
          );
          console.log(
        ...
        case 17:
          ...
          if (!txnSID) {
            console.log(
              '\uD83D\uDE80 ~ file: integration.ts ~ line 477 ~ delegateFraTransactionSubmit ~ Could not retrieve the transaction with a handle ' +
                resultHandle +
                '. Response was: ',
              transactionStatus,
            );
...
var delegateFraTransactionAndClaimRewards = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var password,
      Ledger,
      pkey,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 19:
          ...
          txnSID = Committed && Array.isArray(Committed) ? Committed[0] : null;
          console.log(
            '🚀 ~ file: run.ts ~ line 472 ~ delegateFraTransactionAndClaimRewards ~ txnSID',
            txnSID,
          );
          if (!txnSID) {
            console.log(
              '\uD83D\uDE80 ~ file: integration.ts ~ line 477 ~ delegateFraTransactionAndClaimRewards ~ Could not retrieve the transaction with a handle ' +
                resultHandle +
                '. Response was: ',
              transactionStatus,
            );
...
var unstakeFraTransactionSubmit = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var password,
      Ledger,
      pkey,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 13:
          ...
          if (!txnSID) {
            console.log(
              '\uD83D\uDE80 ~ file: integration.ts ~ line 477 ~ unstakeFraTransactionSubmit ~ Could not retrieve the transaction with a handle ' +
                resultHandleSend +
                '. Response was: ',
              transactionStatusSend,
            );
        ...
        case 25:
          ...
          txnSIDDelegate =
            CommittedDelegate && Array.isArray(CommittedDelegate) ? CommittedDelegate[0] : null;
          console.log(
            '🚀 ~ file: run.ts ~ line 472 ~ unstakeFraTransactionSubmit ~ txnSIDDelegate',
            txnSIDDelegate,
          );
          if (!txnSIDDelegate) {
            console.log(
...
var getSidsForAsset = function (senderOne, assetCode) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            api_1.TripleMasking.barToAbarAmount(walletInfo, amount, assetCode, anonKeys.axfrPublicKey),
          ];
        case 4:
          (_a = _b.sent()),
            (transactionBuilder = _a.transactionBuilder),
      ...
      switch (_a.label) {
        case 0:
          anonKeys = {
            ...
            axfrSpendKey:
              '35lTZXcgMJdrsFeLkhfWQFM4mGTY2-K0scHcvxwEEQdQHkOtOVmvY7h07mKljbwDwtcZ7V_gST7TZWgj8pwd8A==',
            axfrViewKey: '',
            name: 'AnonWallet2',
          };
...
var createTestBarsMulti = function (senderOne, asset1Code, derivedAsset1Code) {
  return __awaiter(void 0, void 0, void 0, function () {
...
var abarToAbarFraOneFraAtxoForFee = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var anonKeysSender,
      anonKeysReceiver,
      walletInfo,
      ...
      _i,
      givenCommitmentsListSender_1,
      givenCommitment,
      balancesCommitment,
      ownedAbarsResponseTwo,
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 4:
          ...
          return [4 /*yield*/, barToAbar([fAssetSidOne], pkey)];
        case 5:
          ...
          _c.label = 6;
        case 6:
          if (!(_i < givenCommitmentsListSender_1.length)) return [3 /*break*/, 10];
        ...
        case 11:
          ...
          console.log(
            '🚀 ~ file: run.ts ~ line 1388 ~ abarToAbarData',
            JSON.stringify(abarToAbarData, null, 2),
          );
        ...
        case 12:
          ...
          console.log(
            'will wait for ' +
              waitingTimeBeforeCheckTxStatus +
              'ms and then check balances for both sender and receiver commitments',
          );
          return [4 /*yield*/, (0, testHelpers_1.waitForBlockChange)()];
        case 13:
          _c.sent();
...
var abarToAbarFraMultipleFraAtxoForFee = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var anonKeysSender,
      anonKeysReceiver,
      walletInfo,
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 5:
          ...
          _c.label = 6;
        case 6:
          if (!(_i < givenCommitmentsListSender_2.length)) return [3 /*break*/, 10];
...
var abarToAbarCustomOneFraAtxoForFee = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var anonKeysSender,
      anonKeysReceiver,
      walletInfo,
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 7:
          ...
          return [4 /*yield*/, barToAbar([cAssetSidOne, cAssetSidTwo], pkey)];
        case 8:
...
var abarToAbarCustomMultipleFraAtxoForFee = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var anonKeysSender,
      anonKeysReceiver,
      walletInfo,
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 9:
          fraAssetSids = _c.sent();
          (fAssetSidOne = fraAssetSids[0]), (fAssetSidTwo = fraAssetSids[1]);
          return [4 /*yield*/, barToAbar([fAssetSidOne, fAssetSidTwo], pkey)];
        case 10:
          fraAssetCommitmentsList = _c.sent();
          givenCommitmentsListSender = __spreadArray(
            __spreadArray([], customAssetCommitmentsList, true),
...
var abarToAbarFraMultipleFraAtxoForFeeSendAmount = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var anonKeysSender,
      anonKeysReceiver,
      walletInfo,
      ...
      switch (_c.label) {
        ...
        case 4:
          ...
          (fAssetSidOne = fraAssetSids[0]),
            ...
            (fAssetSidFive = fraAssetSids[4]);
          return [4 /*yield*/, barToAbar([fAssetSidOne, fAssetSidTwo, fAssetSidThree, fAssetSidFour], pkey)];
        case 5:
          fraAssetCommitmentsList = _c.sent();
          return [4 /*yield*/, (0, testHelpers_1.waitForBlockChange)()];
        case 6:
          ...
          _c.label = 7;
        case 7:
          if (!(_i < givenCommitmentsListSender_5.length)) return [3 /*break*/, 11];
        ...
        case 10:
          ...
          return [3 /*break*/, 7];
        case 11:
          return [4 /*yield*/, api_1.Account.getBalance(walletInfo, fraCode)];
        case 12:
        ...
        case 13:
          ...
          (0,
          utils_1.log)('🚀 ~ file: run.ts ~ line 2048 ~ abarToAbarFraMultipleFraAtxoForFeeSendAmount ~ totalExpectedFee', totalExpectedFee);
          return [
            4 /*yield*/,
...
var abarToAbarCustomMultipleFraAtxoForFeeSendAmount = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var anonKeysSender,
      anonKeysReceiver,
      walletInfo,
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 11:
          ...
          additionalOwnedAbarItems = [];
          (_i = 0), (givenCommitmentsListSender_6 = givenCommitmentsListSender);
          _c.label = 12;
        case 12:
          if (!(_i < givenCommitmentsListSender_6.length)) return [3 /*break*/, 16];
          givenCommitment = givenCommitmentsListSender_6[_i];
          return [4 /*yield*/, api_1.TripleMasking.getBalance(anonKeysSender, [givenCommitment])];
        case 13:
          balancesCommitment = _c.sent();
          console.log(
        ...
        case 22:
          ...
          commitmentsMap = abarToAbarData.commitmentsMap;
          retrivedCommitmentsListReceiver = [];
          for (_b = 0, commitmentsMap_6 = commitmentsMap; _b < commitmentsMap_6.length; _b++) {
            commitmentsMapEntry = commitmentsMap_6[_b];
            (commitmentKey = commitmentsMapEntry.commitmentKey),
              (commitmentAxfrPublicKey = commitmentsMapEntry.commitmentAxfrPublicKey);
            if (commitmentAxfrPublicKey === anonKeysSender.axfrPublicKey) {
              givenCommitmentsListSender.push(commitmentKey);
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 7:
          ...
          return [4 /*yield*/, (0, exports.getSidsForAsset)(pkey, derivedAssetCode)];
        case 8:
          customAssetSids = _b.sent();
          return [4 /*yield*/, barToAbar(customAssetSids, pkey)];
        case 9:
          customAssetCommitmentsList = _b.sent();
          return [4 /*yield*/, (0, exports.getSidsForAsset)(pkey, fraAssetCode)];
        case 10:
          ...
          return [4 /*yield*/, barToAbar([fAssetSidOne, fAssetSidTwo, fAssetSidThree, fAssetSidFour], pkey)];
        case 11:
          fraAssetCommitmentsList = _b.sent();
          return [4 /*yield*/, (0, testHelpers_1.waitForBlockChange)()];
        case 12:
          _b.sent();
          givenCommitmentsListSender = __spreadArray(
        ...
        case 15:
          (_a = _b.sent()),
            (transactionBuilder = _a.transactionBuilder),
            (abarToBarData = _a.abarToBarData),
        ...
        case 19:
          ...
          return [4 /*yield*/, api_1.Account.getBalance(toWalletInfo, assetCodeToUse)];
        case 20:
          assetBalanceAfterAbarToBar = _b.sent();
          console.log(
...
var abarToAbarFraMultipleFraAtxoForFeeSendAmountTotalFee = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var anonKeysSender,
      anonKeysReceiver,
      walletInfo,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 4:
          ...
          return [4 /*yield*/, barToAbar([fAssetSidOne, fAssetSidTwo, fAssetSidThree, fAssetSidFour], pkey)];
        case 5:
          fraAssetCommitmentsList = _a.sent();
          return [4 /*yield*/, (0, testHelpers_1.waitForBlockChange)()];
        case 6:
          _a.sent();
          givenCommitmentsListSender = __spreadArray([], fraAssetCommitmentsList, true);
          additionalOwnedAbarItems = [];
          (_i = 0), (givenCommitmentsListSender_7 = givenCommitmentsListSender);
          _a.label = 7;
        case 7:
          if (!(_i < givenCommitmentsListSender_7.length)) return [3 /*break*/, 11];
          givenCommitment = givenCommitmentsListSender_7[_i];
          return [4 /*yield*/, api_1.TripleMasking.getBalance(anonKeysSender, [givenCommitment])];
        case 8:
          balancesCommitment = _a.sent();
          console.log(
            '🚀 ~ file: run.ts ~ line 2138 ~ abarToAbar ~ balancesCommitment to be used',
            balancesCommitment,
          );
        ...
        case 11:
          return [4 /*yield*/, api_1.Account.getBalance(walletInfo, fraCode)];
        case 12:
          fraBalanceBeforeAbarToAbar = _a.sent();
          console.log(
            '🚀 ~ file: run.ts ~ line 2253 ~ abarToBar ~ fraBalanceBeforeAbarToAbar',
            fraBalanceBeforeAbarToAbar,
          );
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 2:
          ...
          console.log(
            '🚀 ~ file: run.ts ~ line 1396 ~ abarToBar ~ ownedAbarToUseAsSource',
            ownedAbarToUseAsSource,
          );
          return [
            4 /*yield*/,
            api_1.TripleMasking.abarToBar(anonKeysSender, walletInfo.publickey, [ownedAbarToUseAsSource]),
          ];
        case 3:
          (_a = _b.sent()),
            (transactionBuilder = _a.transactionBuilder),
            (abarToBarData = _a.abarToBarData),
            (receiverWalletInfo = _a.receiverWalletInfo);
      ...
      switch (_a.label) {
        case 0:
          anonKeysSender = {
            ...
            axfrSpendKey:
              'Gsppgb5TA__Lsry9TMe9hBZdn_VOU4FS1oCaHrdLHQCgOiwRkH26riOjFwzrET33dcd1LAGz3TPYMTODtDNK6w==',
            axfrViewKey: '',
          };
          subject = '2faWWWW8QyXCnpvzX5tADsgSUiRZc55KCPd1ttPfrF7E';
          return [
            4 /*yield*/,
            api_1.TripleMasking.getNullifierHashesFromCommitments(anonKeysSender, [subject]),
          ];
        case 1:
          hashes = _a.sent();
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            api_1.Evm.hashAddressTofraAddress('0xfd66Bd7839Ed3AeC90f5F54ab2E11E7bF2FF4be5'),
          ];
        case 1:
          addr = _a.sent();
          console.log(addr);
        ...
        case 0:
          data2 = [
            33,
            {
              ...
              ctext: [
                153, 62, 220, 132, 222, 139, 46, 13, 77, 111, 92, 117, 139, 60, 245, 53, 247, 132, 69, 227,
                69, 186, 173, 123, 147, 193, 177, 244, 148, 26, 186, 90, 19, 157, 1, 113, 170, 113, 165, 15,
                76, 15, 83, 82, 138, 161, 98, 95, 34, 54, 118, 251, 30, 232, 104, 241, 101, 249, 228, 103,
                153, 149, 249, 145, 174, 179, 176, 156, 255, 163, 40, 26, 105, 206, 199, 37, 102, 217, 160,
                234, 79, 197, 103, 171, 213, 122, 14, 204,
              ],
            },
          ];
