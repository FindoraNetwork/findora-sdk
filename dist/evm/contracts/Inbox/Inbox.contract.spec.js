...
describe("Inbox (contract test) \"" + rpcUrl + "\"", function () {
    ...
    it('deploys a contract with a default assigned message', function () { return __awaiter(void 0, void 0, void 0, function () {
        var message;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('updates a message with a given value', function () { return __awaiter(void 0, void 0, void 0, function () {
        var currentMessage;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
