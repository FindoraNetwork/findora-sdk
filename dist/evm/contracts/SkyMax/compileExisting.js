...
var contractName = 'Existing';
var contractPath = path_1.default.resolve(__dirname, './', contractName + ".sol");
var source = fs_1.default.readFileSync(contractPath, 'utf8');
var result = solc_1.default.compile(source, 1).contracts[":" + contractName];
exports.contractInterface = result.interface;
exports.contractBytecode = result.bytecode;
//# sourceMappingURL=compileExisting.js.map