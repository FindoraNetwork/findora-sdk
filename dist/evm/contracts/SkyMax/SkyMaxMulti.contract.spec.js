...
describe("SkyMaxMulti Contract (contract test) \"" + rpcUrl + "\"", function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    accounts = _a.sent();
                    (0, testHelpers_1.timeStart)();
                    return [4 /*yield*/, new web3.eth.Contract(JSON.parse(compileDeployed_1.contractInterface))
                ...
                case 3:
                    ...
                    (0, testHelpers_1.timeStart)();
                    return [4 /*yield*/, new web3.eth.Contract(JSON.parse(compileExisting_1.contractInterface))
                            .deploy({ data: compileExisting_1.contractBytecode, arguments: [contractDeployed.options.address] })
                            .send((0, testHelpers_1.getPayloadWithGas)(accounts[0], networkId))];
                case 4:
                    contractExisting = _a.sent();
                    (0, testHelpers_1.timeLog)('Contract deployment');
                    return [2 /*return*/];
            }
        });
    ...
    it('validates that internal contract data can be updated by another contract', function () { return __awaiter(void 0, void 0, void 0, function () {
        var messageNum;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    (0, testHelpers_1.timeStart)();
                    return [4 /*yield*/, contractExisting.methods.setA_Signature(456).send(__assign({}, (0, testHelpers_1.getPayloadWithGas)(accounts[0], networkId)))];
                case 1:
                    _a.sent();
                    (0, testHelpers_1.timeLog)('Call contract method with send a tx');
                    (0, testHelpers_1.timeStart)();
                    return [4 /*yield*/, contractDeployed.methods.a().call()];
                case 2:
                    messageNum = _a.sent();
    ...
    it('validates that contract balance can be updated by the call from another contract', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    (0, testHelpers_1.timeStart)();
                    return [4 /*yield*/, contractExisting.methods.enter_Signature().send(__assign(__assign({}, (0, testHelpers_1.getPayloadWithGas)(accounts[0], networkId)), { value: web3.utils.toWei('0.1', 'ether') }))];
                case 1:
                    _a.sent();
                    (0, testHelpers_1.timeLog)('Call contract method with send a tx');
                    (0, testHelpers_1.timeStart)();
                    return [4 /*yield*/, web3.eth.getBalance(contractDeployed.options.address)];
                case 2:
    ...
    it('validates that contract can transfer balance to the address, which is added from another contract', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    (0, testHelpers_1.timeStart)();
                    return [4 /*yield*/, contractDeployed.methods.pickWinner().send((0, testHelpers_1.getPayloadWithGas)(accounts[0], networkId))];
                case 4:
                    _a.sent();
                    (0, testHelpers_1.timeLog)('Call contract method with send a tx');
                    (0, testHelpers_1.timeStart)();
    ...
    it('validates that contract can maintain mappings coming from another contract', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    (0, testHelpers_1.timeLog)('Call contract method with send a tx');
                    (0, testHelpers_1.timeStart)();
                    return [4 /*yield*/, contractExisting.methods.enter_Signature().send(__assign(__assign({}, (0, testHelpers_1.getPayloadWithGas)(accounts[1], networkId)), { value: web3.utils.toWei('0.2', 'ether') }))];
                case 2:
                    _a.sent();
                    (0, testHelpers_1.timeLog)('Call contract method with send a tx');
                    (0, testHelpers_1.timeStart)();
                ...
                case 3:
                    ...
                    (0, testHelpers_1.timeStart)();
                    return [4 /*yield*/, contractDeployed.methods.getContribution(accounts[0]).call()];
                case 4:
                    balancFirstAccount = _a.sent();
                    (0, testHelpers_1.timeLog)('Call contract method');
                    expect(web3.utils.fromWei(balancFirstAccount, 'ether')).toEqual('0.1');
                    (0, testHelpers_1.timeStart)();
                    return [4 /*yield*/, contractDeployed.methods.getContribution(accounts[1]).call()];
                case 5:
    ...
    it('validates that contract can validate required rules (i.e. minimum accepted value for the payable function) when it is called from another contract', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, contractExisting.methods.enter_Signature().send({
                            from: accounts[0],
                            value: 1,
                        })];
                case 2:
    ...
    it('validates that contract can maintain arrays created by another contract', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    (0, testHelpers_1.timeLog)('Call contract method with send a tx');
                    (0, testHelpers_1.timeStart)();
                    return [4 /*yield*/, contractDeployed.methods.players(0).call()];
                case 3:
                    firstPlayer = _a.sent();
                    (0, testHelpers_1.timeLog)('Call contract method');
                    expect(firstPlayer).toEqual(accounts[0]);
                    (0, testHelpers_1.timeStart)();
                    return [4 /*yield*/, contractDeployed.methods.players(1).call()];
                case 4:
    ...
    it('validates that contract can parse transaction event logs to verify outputs in the event, created by a trigger from another contract, get and assert value for the key', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    secondBlock = 0;
                    (0, testHelpers_1.timeStart)();
                    return [4 /*yield*/, contractExisting.methods
                            .enter_Signature()
                ...
                case 2:
                    ...
                    (0, testHelpers_1.timeLog)('Call contract method with send a tx');
                    (0, testHelpers_1.timeStart)();
                    return [4 /*yield*/, contractDeployed.getPastEvents('Transferred', {
