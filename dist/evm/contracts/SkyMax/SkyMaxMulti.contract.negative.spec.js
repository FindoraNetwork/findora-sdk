...
describe("SkyMaxMulti Contract (contract test negative) \"".concat(rpcUrl, "\""), function () {
    ...
    it('validates that contract does not crashes and returns an error if method is called with invalid type of a parameter', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, contractExisting.methods.enter_Signature().send(__assign(__assign({}, (0, testHelpers_1.getPayloadWithGas)(accounts[0], networkId)), { value: 'aaaaaa' }))];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
    ...
    it('validates that contract does not crashes and returns an error if method is called with invalid number of parameters', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, contractExisting.methods.setA_Signature().send((0, testHelpers_1.getPayloadWithGas)(accounts[0], networkId))];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
