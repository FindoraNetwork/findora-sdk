...
export interface StakingEventsContext {
  Delegation(
    parameters: {
      filter?: { validator?: string | string[]; delegator?: string | string[] };
      fromBlock?: number;
  ...
  Jailed(
    parameters: {
      filter?: { validator?: string | string[] };
      fromBlock?: number;
      toBlock?: 'latest' | number;
      topics?: string[];
    },
  ...
  Stake(
    parameters: {
      filter?: { validator?: string | string[]; staker?: string | string[] };
      fromBlock?: number;
      toBlock?: 'latest' | number;
      topics?: string[];
    },
...
export type StakingMethodNames =
  ...
  | 'initialize'
  | 'latestEpoch'
  | 'maxDelegationAmountBasedOnTotalAmount'
  | 'punish'
  | 'releaseFromJail'
  | 'renounceRole'
  | 'revokeRole'
